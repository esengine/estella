...
program
    ...
    .option('-t, --target <target>', 'Build target (web, wechat, spine, spine38, spine41, spine43, physics, physics-wechat, spine-wechat, basis, basis-wechat, sdk, all)', 'web')
    ...
    .action(async (options) => {
        ...
        try {
            ...
            const targets = options.target === 'all'
                ? ['web', 'wechat', 'spine', 'spine38', 'spine41', 'spine43', 'physics', 'physics-wechat', 'spine-wechat', 'basis', 'basis-wechat', 'videodec', 'videodec-wechat']
                : [options.target];
