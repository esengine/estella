import { E as Entity, a as ESEngineModule, V as Vec2, c as Color, C as CppRegistry, e as Vec4, P as Padding, T as TextureHandle, b as CppResourceManager } from './shared/wasm.js';
...
import { g as PostProcessStack, h as ShaderHandle, P as Plugin, A as App, R as ResourceDef, M as MaterialHandle, W as World, i as ComponentDef, B as BuiltinComponentDef, j as TransformData, k as AnyComponentDef, m as Assets$1, n as SceneData, o as SpineWasmModule, p as SceneConfig, q as BlendMode, r as WebAppOptions, S as SpineWasmProvider } from './shared/app.js';
export { s as Added, t as AddedWrapper, u as AssetFieldType, v as BitmapText, x as BitmapTextData, y as BuiltinBridge, z as Camera, D as CameraData, E as CameraRenderParams, F as Canvas, G as CanvasData, H as Changed, I as ChangedWrapper, J as Children, K as ChildrenData, L as ClearFlags, N as Commands, O as CommandsDescriptor, Q as CommandsInstance, U as ComponentData, V as Disabled, X as DrawCallback, Y as EmitterShape, Z as EntityCommands, _ as EventDef, $ as EventReader, a0 as EventReaderDescriptor, a1 as EventReaderInstance, a2 as EventRegistry, a3 as EventWriter, a4 as EventWriterDescriptor, a5 as EventWriterInstance, a6 as GetWorld, a7 as GetWorldDescriptor, a8 as InferParam, a9 as InferParams, aa as LocalTransform, ab as LocalTransformData, ac as Material, ad as MaterialAssetData, ae as MaterialOptions, af as Mut, ag as MutWrapper, ah as Name, ai as NameData, aj as Parent, ak as ParentData, al as ParticleEasing, am as ParticleEmitter, an as ParticleEmitterData, ao as PluginDependency, ap as PostProcessVolume, aq as PostProcessVolumeData, ar as ProjectionType, as as Query, at as QueryBuilder, au as QueryDescriptor, av as QueryInstance, aw as QueryResult, ax as Removed, ay as RemovedQueryDescriptor, az as RemovedQueryInstance, aA as RenderParams, aB as RenderPipeline, aC as Res, aD as ResDescriptor, aE as ResMut, aF as ResMutDescriptor, aG as ResMutInstance, aH as RunCondition, aI as ScaleMode, aJ as SceneComponentData, aK as SceneContext, aL as SceneEntityData, aM as SceneLoadOptions, aN as SceneLoadProgressCallback, aO as SceneManager, aP as SceneManagerState, aQ as SceneOwner, aR as SceneOwnerData, aS as SceneStatus, aT as Schedule, aU as ShaderSources, aV as ShapeRenderer, aW as ShapeRendererData, aX as ShapeType, aY as SimulationSpace, aZ as SliceBorder, a_ as SpineAnimation, a$ as SpineAnimationData, b0 as SpineLoadResult, b1 as Sprite, b2 as SpriteData, b3 as SystemDef, b4 as SystemOptions, b5 as SystemParam, b6 as SystemRunner, b7 as TextureInfo, b8 as TextureRef, b9 as Time, ba as TimeData, bb as Transform, bc as TransitionOptions, bd as UniformValue, be as Velocity, bf as VelocityData, bg as Viewport, bh as WorldTransform, bi as WorldTransformData, bj as addStartupSystem, bk as addSystem, bl as addSystemToSchedule, bm as clearDrawCallbacks, bn as clearUserComponents, bo as defineComponent, bp as defineEvent, bq as defineResource, br as defineSystem, bs as defineTag, bt as findEntityByName, bu as flushPendingSystems, bv as getComponent, bw as getComponentAssetFieldDescriptors, bx as getComponentAssetFields, by as getComponentDefaults, bz as getComponentSpineFieldDescriptor, bA as getUserComponent, bB as initMaterialAPI, bC as isBuiltinComponent, bD as isTextureRef, bE as loadComponent, bF as loadSceneData, bG as loadSceneWithAssets, bH as readPtrField, bI as registerComponent, bJ as registerDrawCallback, bK as registerMaterialCallback, bL as remapEntityFields, bM as shutdownMaterialAPI, bN as unregisterComponent, bO as unregisterDrawCallback, bP as updateCameraAspectRatio, bQ as wrapSceneSystem, bR as writePtrField } from './shared/app.js';
...
declare class GestureDetector {
    ...
    private processStarts_;
    private lastPositions_;
    private processActive_;
    private processEnds_;
    private processPinch_;
    reset(): void;
}

declare function getColorMatrixShader(): ShaderHandle;
declare const Filters: {
    ...
    invertMatrix(): number[];
    getColorMatrixShader: typeof getColorMatrixShader;
};
...
declare const SpriteFilter: {
    ...
    setOutlineColor(material: MaterialHandle, color: {
        r: number;
        g: number;
        b: number;
        a: number;
...
declare function setEntityVisible(world: World, entity: Entity, visible: boolean): void;
declare function isEntityVisible(world: World, entity: Entity): boolean;
declare function setEntityActive(world: World, entity: Entity, active: boolean): void;
declare function isEntityActive(world: World, entity: Entity): boolean;
...
interface CacheAsBitmapData {
    enabled: boolean;
    dirty: boolean;
    width: number;
    height: number;
}
declare const CacheAsBitmap: ComponentDef<CacheAsBitmapData>;
declare function getCacheForEntity(entityId: number): BitmapCache | undefined;
declare function setCacheForEntity(entityId: number, cache: BitmapCache): void;
declare function removeCacheForEntity(entityId: number): BitmapCache | undefined;
...
declare function pointInHitArea(px: number, py: number, area: HitAreaShape): boolean;
...
declare function createSocket(options: GameSocketOptions): GameSocket | WeChatSocket;

declare const TextureFilter: {
    readonly Nearest: 0;
    readonly Linear: 1;
};
type TextureFilter = (typeof TextureFilter)[keyof typeof TextureFilter];
declare const TextureWrap: {
    readonly Repeat: 0;
    readonly ClampToEdge: 1;
    readonly MirroredRepeat: 2;
};
type TextureWrap = (typeof TextureWrap)[keyof typeof TextureWrap];
declare function setTextureFilter(textureId: number, filter: TextureFilter): void;
declare function setTextureWrap(textureId: number, wrap: TextureWrap): void;
declare function setTextureParams(textureId: number, minFilter: TextureFilter, magFilter: TextureFilter, wrapS: TextureWrap, wrapT: TextureWrap): void;

declare const CameraUtils: {
...
interface SpriteAnimEvent {
    frame: number;
    name: string;
    data?: unknown;
}
type SpriteAnimEventHandler = (event: SpriteAnimEvent, entity: Entity) => void;
...
declare function onAnimEvent(entity: Entity, handler: SpriteAnimEventHandler): () => void;
declare function onAnimEventGlobal(handler: SpriteAnimEventHandler): () => void;
declare function removeAnimEventListeners(entity: Entity): void;
...
declare class TweenGroup implements Completable {
    private readonly tweens_;
    private onComplete_;
    private completed_;
...
declare class TweenSequence implements Completable {
    private readonly factories_;
    private currentIndex_;
    private currentTween_;
    private completed_;
    private cancelled_;
    private paused_;
    private onComplete_;
...
declare const TimerRes: ResourceDef<TimerManager>;
declare const timerPlugin: Plugin;

type LifecycleEvent = 'show' | 'hide' | 'pause' | 'resume';
...
declare const Lifecycle: ResourceDef<LifecycleManager>;
interface LifecyclePluginOptions {
    autoPause?: boolean;
}
declare const lifecyclePlugin: (options?: LifecyclePluginOptions) => Plugin;
...
export { AnimOverride, AnimationPlugin, AnyComponentDef, App, AppContext, AssetPlugin, AssetRefCounter, Assets, AsyncCache, AttenuationModel, Audio, AudioBus, AudioListener, AudioMixer, AudioPlugin, AudioPool, AudioSource, BlendMode, BuiltinComponentDef, Button, ButtonState, CacheAsBitmap, CacheBitmap, CameraUtils, CollectionItem, CollectionView, CollectionViewPlugin, Color, ComponentDef, CppRegistry, CppResourceManager, DARK_THEME, DEFAULT_DESIGN_HEIGHT, DEFAULT_DESIGN_WIDTH, DEFAULT_FALLBACK_DT, DEFAULT_FIXED_TIMESTEP, DEFAULT_FONT_FAMILY, DEFAULT_FONT_SIZE, DEFAULT_GRAVITY, DEFAULT_LINE_HEIGHT, DEFAULT_MAX_DELTA_TIME, DEFAULT_PIXELS_PER_UNIT, DEFAULT_SPINE_SKIN, DEFAULT_SPRITE_SIZE, DEFAULT_TEXT_CANVAS_SIZE, DEFAULT_UI_CAMERA_INFO, DataType, DefaultImageResolver, DragPlugin, DragState, Draggable, Draw, Dropdown, DropdownPlugin, ESEngineModule, EasingType, Entity, EntityStateMap, FanLayout, FanLayoutProvider, FillDirection, FillMethod, FillOrigin, Filters, FlushReason, FocusManager, FocusManagerState, FocusPlugin, Focusable, FrameHistory, GLDebug, GameSocket, Geometry, GestureDetector, Graphics, GridLayout, GridLayoutProvider, Image, ImagePlugin, ImageType, Input, InputPlugin, InputState, Interactable, ItemPool, Lifecycle, LifecycleManager, LinearLayout, LinearLayoutProvider, LogLevel, Logger, LoopMode, MaskMode, MaterialHandle, MaterialLoader, PTR_LAYOUTS, Particle, ParticlePlugin, PhysicsWasmModule, Plugin, PostProcess, PostProcessPlugin, PostProcessStack, PrefabServer, Prefabs, PrefabsPlugin, PreviewPlugin, ProgressBar, ProgressBarDirection, ProgressBarPlugin, RenderStage, RenderTexture, RenderType, Renderer, ResourceDef, RuntimeConfig, SafeArea, SafeAreaPlugin, SceneConfig, SceneData, ScreenInfo, ScreenOrientation, ScrollAlign, ScrollView, ScrollViewPlugin, Selectable, SelectionMode, ShaderHandle, Slider, SliderDirection, SliderPlugin, SpriteAnimator, SpriteFilter, StateMachinePlugin, Stats, StatsCollector, StatsOverlay, StatsPlugin, Storage, SubmitSkipFlags, Text, TextAlign, TextInput, TextInputPlugin, TextOverflow, TextPlugin, TextRenderer, TextVerticalAlign, TextureFilter, TextureHandle, TextureWrap, Tilemap, TilemapAPI, TilemapLayer, TilemapPlugin, TimelineControl, TimelinePlayer, TimelinePlugin, TimerHandle, TimerManager, TimerRes, Toggle, TogglePlugin, TransformData, Tween, TweenCompose, TweenGroup, TweenHandle, TweenSequence, TweenState, TweenTarget, UI, UICameraInfo, UIEventQueue, UIEvents, UIInteraction, UIInteractionPlugin, UILayoutGeneration, UILayoutPlugin, UIMask, UIMaskPlugin, UIRect, UIRenderOrderPlugin, UIRenderer, UIThemeRes, UIVisualType, Vec2, Vec4, WeChatSocket, WebAppOptions, WebAssetProvider, World, animationPlugin, applyBuildRuntimeConfig, applyDirectionalFill, applyOverrides, applyRuntimeConfig, assetPlugin, audioPlugin, calculateAttenuation, calculatePanning, cleanupAllPostProcessVolumes, cleanupPostProcessVolume, clearAllCaches, clearAnimClips, clearTilemapSourceCache, clearTimelineHandles, cloneComponentData, cloneComponents, collectNestedPrefabPaths, collectionGetItemEntity, collectionInsertItems, collectionRefreshItem, collectionRefreshItems, collectionRemoveItems, collectionViewPlugin, colorScale, colorWithAlpha, computeFanPositions, computeFillAnchors, computeFillSize, computeHandleAnchors, computeUIRectLayout, corePlugin, createRuntimeSceneConfig, createSocket, createWebApp, debug, defaultFrameStats, dragPlugin, dropdownPlugin, error, evictTextureDimensions, extractAnimClipTexturePaths, flattenPrefab, focusPlugin, getAddressableType, getAddressableTypeByEditorType, getAllAssetExtensions, getAllEffectDefs, getAnimClip, getAssetBuildTransform, getAssetMimeType, getAssetTypeEntry, getCacheForEntity, getCollectionAdapter, getCustomExtensions, getDefaultContext, getEditorType, getEffectDef, getEffectTypes, getImageResolver, getLayoutProvider, getLogger, getPlatform, getPlatformType, getResourceManager, getTextureDimensions, getTilemapSource, getTimelineHandle, getWeChatPackOptions, imagePlugin, info, initDrawAPI, initGLDebugAPI, initGeometryAPI, initParticleAPI, initPlayableRuntime, initPostProcessAPI, initRendererAPI, initResourceManager, initRuntime, initTilemapAPI, initTweenAPI, initUIBuilder, inputPlugin, instantiatePrefab, intersectRects, invertMatrix4, isCustomExtension, isEditor, isEntityActive, isEntityVisible, isKnownAssetExtension, isPlatformInitialized, isPlayMode, isRuntime, isWeChat, isWeb, lifecyclePlugin, loadRuntimeScene, loadTiledMap, looksLikeAssetPath, makeInteractable, onAnimEvent, onAnimEventGlobal, parseAnimClipData, parseRichText, parseTiledMap, parseTimelineAsset, parseTmjJson, particlePlugin, platformFetch, platformFileExists, platformInstantiateWasm, platformReadFile, platformReadTextFile, playModeOnly, pointInHitArea, pointInOBB, pointInWorldRect, postProcessPlugin, prefabsPlugin, preloadNestedPrefabs, progressBarPlugin, quaternionToAngle2D, registerAnimClip, registerAssetBuildTransform, registerLayoutProvider, registerTilemapSource, registerTimelineAsset, remapComponentEntityRefs, removeAnimEventListeners, removeCacheForEntity, removeCollectionAdapter, requireResourceManager, resolveRelativePath, safeAreaPlugin, sceneManagerPlugin, screenToWorld, scrollViewPlugin, setCacheForEntity, setCollectionAdapter, setDefaultContext, setEditorMode, setEntityActive, setEntityColor, setEntityEnabled, setEntityVisible, setImageResolver, setLogLevel, setPlayMode, setTextureFilter, setTextureParams, setTextureWrap, setWasmErrorHandler, shutdownDrawAPI, shutdownGLDebugAPI, shutdownGeometryAPI, shutdownParticleAPI, shutdownPostProcessAPI, shutdownRendererAPI, shutdownResourceManager, shutdownTilemapAPI, shutdownTweenAPI, sliderPlugin, spriteAnimatorSystemUpdate, stateMachinePlugin, statsPlugin, syncFillSpriteSize, syncPostProcessVolume, textInputPlugin, textPlugin, tilemapPlugin, timelinePlugin, timerPlugin, toBuildPath, togglePlugin, transitionTo, uiInteractionPlugin, uiLayoutPlugin, uiMaskPlugin, uiPlugins, uiRenderOrderPlugin, unregisterAnimClip, warn, withChildEntity };
export type { AddressableAssetType, AddressableManifest, AddressableManifestAsset, AddressableManifestGroup, AnimClipAssetData, AssetBuildTransform, AssetContentType, AssetRefInfo, AssetTypeEntry, AssetsData, AudioBackendInitOptions, AudioBufferHandle, AudioBusConfig, AudioHandle, AudioListenerData, AudioMixerConfig, AudioPluginConfig, AudioSourceData, BezierPoints, BitmapCache, ButtonData, ButtonOptions, ButtonTransition, CacheAsBitmapData, CollectionAdapter, CollectionItemData, LayoutResult as CollectionLayoutResult, CollectionViewData, CreateWebAppOptions, DragStateData, DraggableData, DrawAPI, DrawCallInfo, DropShadowFilterOptions, DropdownData, DropdownOptions, EditorAssetType, EditorBridge, EffectDef, EffectUniformDef, FanLayoutData, FlattenContext, FlattenResult, FlexOptions, FocusableData, FrameCaptureData, FrameSnapshot, FrameStats, GameSocketOptions, GeometryHandle, GeometryOptions, GridLayoutData, HitAreaShape, ImageData$1 as ImageData, ImageResolver, ImageSegment, InstantiatePrefabOptions, InstantiatePrefabResult, InteractableData, LabelOptions, LayoutProvider, LayoutRect, LayoutResult$1 as LayoutResult, LifecycleEvent, LifecycleListener, LifecyclePluginOptions, LinearLayoutData, LoadRuntimeSceneOptions, LoadedMaterial, LoadedTilemapLayer, LoadedTilemapSource, LoadedTilemapTileset, LogEntry, LogHandler, NestedPrefabRef, OutlineFilterOptions, PanelOptions, PlatformAdapter, PlatformAudioBackend, PlatformRequestOptions, PlatformResponse, PlatformType, PlayConfig, PlayableRuntimeConfig, PooledAudioNode, PostProcessEffectData, ComponentData as PrefabComponentData, PrefabData, PrefabEntityData, PrefabOverride, ProcessedEntity, ProgressBarData, ProgressBarOptions, PtrLayout, RenderStats, RenderTargetHandle, RenderTextureHandle, RenderTextureOptions, ResolvedImage, RichTextRun, RuntimeAssetProvider, RuntimeBuildConfig, RuntimeInitConfig, SafeAreaData, ScreenRect, ScrollViewData, ScrollViewOptions, SelectableData, ShaderLoader, SliderData, SliderOptions, SocketReadyState, SpatialAudioConfig, SpriteAnimClip, SpriteAnimEvent, SpriteAnimEventHandler, SpriteAnimFrame, SpriteAnimatorData, StatsPluginOptions, StatsPosition, SwipeDirection, TextData, TextInputData, TextInputOptions, TextRenderResult, TextSegment, TextureDimensions, TiledLayerData, TiledMapData, TiledTilesetData, TilemapData, TilemapLayerData, TimelinePlayerData, ToggleData, ToggleOptions, ToggleTransition, TouchPoint, TransitionConfig, TweenOptions, UICameraData, UIEntityDef, UIEvent, UIEventHandler, UIEventType, UIInteractionData, UILayoutGenerationData, UIMaskData, UINode, UIRectData, UIRendererData, UITheme, Unsubscribe, VertexAttributeDescriptor };
