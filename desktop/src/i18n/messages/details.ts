...
export const detailsMessages = defineMessages({
    ...
    'det.unitFraction': { en: 'frac', zh: '比例' },
    ...
    'det.pivotPresets': { en: 'Pivot presets', zh: '轴心预设' },
    ...
    'det.metaVertices': { en: 'Vertices', zh: '顶点数' },
    'det.metaTriangles': { en: 'Triangles', zh: '三角形' },
    'det.metaChannels': { en: 'Channels', zh: '通道' },
