...
export const tileMessages = defineMessages({
    ...
    'tile.oneWayTip': { en: 'One-way platform: painted collision is solid on the chosen side, pass-through from the other', zh: '单向平台：所画碰撞在所选一侧实心、另一侧可穿过' },
    'tile.oneWay.up': { en: 'Solid top (jump-through)', zh: '顶部实心（可上跳穿过）' },
    'tile.oneWay.down': { en: 'Solid bottom (ceiling)', zh: '底部实心（天花板）' },
    'tile.oneWay.left': { en: 'Solid left', zh: '左侧实心' },
    'tile.oneWay.right': { en: 'Solid right', zh: '右侧实心' },
    ...
    'tile.collision.friction': { en: 'Friction', zh: '摩擦力' },
    'tile.collision.bounce': { en: 'Bounce', zh: '弹性' },
    'tile.collision.default': { en: 'default', zh: '默认' },
