...
const conversation = (from = 0): AgentEvent[] => [
  ...
  { type: 'turn_end', steps: 7, mark: { seq: 1 }, endMark: null, tx: null, files: [], acceptance: { verdict: 'unverified', results: [] }, reason: 'end_turn' },
  { type: 'turn_start', prompt: 'bigger buttons', model: 'opus-5', index: from + 1 },
  { type: 'text', delta: 'Done.' },
  { type: 'turn_end', steps: 3, mark: { seq: 2 }, endMark: null, tx: null, files: [], acceptance: { verdict: 'unverified', results: [] }, reason: 'end_turn' },
];
