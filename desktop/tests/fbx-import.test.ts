...
import { importFbxMeshes } from '../../pipeline/src/assets/fbxImport';
import { assembleModelPrefab, materialProducts,
         type ImportedMesh, type ImportedNode } from '../../pipeline/src/assets/modelImport';
import { MeshChannel } from 'esengine';
import { texturedTriangle, skinnedBar } from '../scripts/lib/fbxFixtures.mjs';
