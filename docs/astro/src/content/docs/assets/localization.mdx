...
![A .eslocale string table in the inspector — keys with their values](../../../assets/guides/en/localization.png)
...
- [UI](/docs/ui/overview/) — the `Text` component the binding rides on.
- [Assets](/docs/assets/overview/) — how assets ship and load.
