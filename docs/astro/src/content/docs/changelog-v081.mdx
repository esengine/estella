---
title: v0.8.1
description: ESEngine v0.8.1 release notes
---
...
New Tiled map loader and tilemap rendering pipeline with full editor integration.

- **Tiled JSON loader** — load `.tmj` / `.json` Tiled maps with automatic tileset texture resolution
...
- **`PhysicsDebugDraw`** — visual overlay for physics colliders, joints, and contacts in the editor and at runtime
- Renders wireframe outlines for box, circle, and capsule colliders
