...
- [Scripting](/docs/guides/scripting/) — behaviors are declarative systems; leaves are plain functions.
- [Animation](/docs/guides/animation/) — drive sprite clips from a state machine.
- [Scenes](/docs/guides/scene/) — `.esfsm` / `.esbt` assets load and serialize with the scene.
- [Event Binding](/docs/guides/events/) — a click or a trigger can `fsm.fire` into a state
