...
- **Device** dropdown — *simulates* a target screen (iPhone / iPad / 1080p …) with letterbox
  bars and safe-area insets, to preview how the UI adapts. It's a preview only — it does
  **not** change your design resolution.
