...
If a component fails to deserialize during scene loading, all entities already created for that scene are automatically despawned. This prevents half-initialized entities from lingering in the world.
