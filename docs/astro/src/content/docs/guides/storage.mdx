---
title: Storage
description: Save and load persistent data in ESEngine
---

import { Aside } from '@astrojs/starlight/components';

ESEngine provides a `Storage` API for persisting data locally. It works across Web (localStorage) and WeChat MiniGame (wx storage) platforms with a unified interface.
...
// Remove all ESEngine storage data
Storage.clear();
```
...
| `clear()` | Remove all ESEngine storage data |
...
- [Resources](/microes/core-concepts/resources/) — runtime global state with the Resource system
- [WeChat MiniGame](/microes/guides/wechat/) — WeChat platform specifics
