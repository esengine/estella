...
| **Trigger** | Sensor box | A non-solid region that fires overlap events — see [Markers & Trigger Areas](/docs/guides/markers/). |
...
[**Marker**](/docs/guides/markers/) entities and shape objects into **Trigger Area**
...
- [Markers & Trigger Areas](/docs/guides/markers/) — place gameplay points and trigger
