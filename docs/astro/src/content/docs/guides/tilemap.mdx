...
1. Right-click in the **Hierarchy** panel → **Create** → **Tilemap**
2. In the creation dialog, set the tile size and choose between **Finite** or **Infinite** map mode
3. Assign a tileset image in the **Tilemap** component Inspector
...
1. Right-click in the Hierarchy → **Create** → **Tilemap** (see [Editor Tilemap Creation](#editor-tilemap-creation) above)
2. Use the **Tile Palette** to paint, erase, and manage layers directly in the Scene View
...
<Aside type="tip">
  For imported maps, design in the [Tiled Map Editor](https://www.mapeditor.org/), export as JSON (`.tmj`), and place the file alongside your tileset images in the project assets folder.
</Aside>
