...
<Aside type="note">
When an entity is despawned, all its active tweens are automatically cancelled via `Tween.cancelAll()`. You do not need to manually cancel tweens before destroying entities.
</Aside>
