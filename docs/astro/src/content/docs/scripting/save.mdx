...
Builds before Estella 0.41 kept the same file in the cache directory. If you have
already shipped one, the first launch after the update finds that save and moves
it — your players keep their progress and there is nothing to write.
...
- [Scenes](/docs/world/scenes/) — loading and switching the scenes a save points at.
- [Assets](/docs/assets/overview/) — why bulk data belongs in assets, not in a save slot.
