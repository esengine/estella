...
<Aside type="note">
  ...
  `esengine/physics` 与 `esengine/spine` 子路径上。见[物理](/docs/zh-cn/guides/physics/)
  与 [Spine](/docs/zh-cn/guides/spine/)。
</Aside>
...
的初始化(见[脚本](/docs/zh-cn/guides/scripting/))。
...
- [构建与导出](/docs/zh-cn/guides/build-export/)——侧模块产物在各目标如何发布。
- [物理](/docs/zh-cn/guides/physics/)与 [Spine](/docs/zh-cn/guides/spine/)——
  侧模块背后的两个子路径 API。
