...
能量推进 [bloom 与 tonemap](/docs/zh-cn/guides/postprocess/),亮光会发辉光。
...
- [材质与着色器](/docs/zh-cn/guides/material/) —— 受光材质与自定义着色。
- [后处理](/docs/zh-cn/guides/postprocess/) —— 在受光场景上叠加辉光与调色。
- [精灵与渲染](/docs/zh-cn/guides/sprites/) —— 让 2D 精灵在光下有立体感的法线贴图。
