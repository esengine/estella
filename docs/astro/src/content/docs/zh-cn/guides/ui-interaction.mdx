...
[UI 控制器](/docs/zh-cn/guides/ui-controllers/)。
...
<Aside type="note">
  ...
  方向键驱动。手柄菜单请用[输入映射](/docs/zh-cn/guides/input/)自行驱动选择,
  直接调用控件状态。
</Aside>
...
- [UI 组件](/docs/zh-cn/guides/ui-components/) —— 事件已接好线的控件工厂。
- [UI 控制器](/docs/zh-cn/guides/ui-controllers/) —— 由交互控制器驱动的悬停/按下**视觉**状态。
- [UI 数据绑定](/docs/zh-cn/guides/ui-binding/) —— 基于 `change` 事件的控件值双向绑定。
- [输入](/docs/zh-cn/guides/input/) —— UI 层之下的 `Input` 资源、输入映射与手势。
