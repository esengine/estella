...
把控制权交给[状态机](/docs/zh-cn/gameplay/ai/overview/)的动作——Estella 已经有图编辑器了。
...
[物理](/docs/zh-cn/gameplay/physics/)接触也走同一条通道（`Physics2DEventType`），所以
...
突破口——点击发出一个触发器，实体的[状态机](/docs/zh-cn/gameplay/ai/overview/)来决定它意味着什么：
