...
绝对定位、锚点预设和配方。组件模型总览请从 [UI](/docs/zh-cn/ui/overview/) 开始。
...
[屏幕与分辨率](/docs/zh-cn/core-concepts/screen/)和[相机](/docs/zh-cn/graphics/camera/)。
...
alignItems: Center`——[UI](/docs/zh-cn/ui/overview/) 快速上手的模式),或把面板本身设为
...
- [UI](/docs/zh-cn/ui/overview/)——组件模型总览与快速上手。
- [UI 文本](/docs/zh-cn/ui/text/)——`Text` 如何在盒内测量与对齐。
- [UI 交互](/docs/zh-cn/ui/interaction/)——对排布好的盒子做命中测试。
- [UI 组件](/docs/zh-cn/ui/widgets/)——建立在这些原语上的控件(含移动端安全区)。
- [相机](/docs/zh-cn/graphics/camera/)——相机、画布缩放模式与 UI 框。
