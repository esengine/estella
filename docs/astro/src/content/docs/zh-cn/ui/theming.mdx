...
- [UI](/docs/zh-cn/guides/ui/) —— 令牌所着色的组件模型。
- [UI 控件](/docs/zh-cn/guides/ui-components/) —— 消费令牌的控件工厂。
- [UI 控制器](/docs/zh-cn/guides/ui-controllers/) —— 主题状态色所依附的 `$interaction` gear。
- [数据绑定](/docs/zh-cn/guides/ui-binding/) —— 把响应式值写进组件字段。
