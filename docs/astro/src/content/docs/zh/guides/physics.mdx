...
| Contact Hertz | `120` | 接触刚度（周期/秒）。越高穿透越少但抖动越明显 |
| Contact Damping Ratio | `10` | 接触弹性阻尼。越低重叠恢复越快但弹性越强 |
| Contact Speed | `10` | 最大重叠修正速度（米/秒） |
...
- [瓦片地图](/microes/zh/guides/tilemap/) — 基于瓦片的碰撞生成
