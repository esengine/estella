---
title: 数据存储
description: 在 ESEngine 中保存和读取本地持久化数据
---

import { Aside } from '@astrojs/starlight/components';

ESEngine 提供了 `Storage` API 用于本地数据持久化，在 Web（localStorage）和微信小游戏（wx storage）平台上使用统一的接口。
...
- [场景](/microes/zh/guides/scenes/) — 场景加载与管理
- [资源](/microes/zh/core-concepts/resources/) — Resource 系统的运行时全局状态
- [微信小游戏](/microes/zh/guides/wechat/) — 微信平台相关
