...
export const COMPONENT_DOCS: Record<string, ComponentDoc> = {
  ...
  RigidBody3D: { category: 'physics', summary: 'Puts the entity under the 3D solver — its own component set, so a 2D scene keeps the world it already has.', doc: 'gameplay/physics-3d', anchor: 'bodies', anchorZh: 'bodies' },
