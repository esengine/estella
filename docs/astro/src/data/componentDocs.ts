...
export const COMPONENT_DOCS: Record<string, ComponentDoc> = {
  ...
  // ── Gameplay ───────────────────────────────────────────────────────────────
  NavAgent: { category: 'gameplay', summary: 'Steers an entity along a path found on the navigation grid.', doc: 'gameplay/ai', anchor: 'moving-an-agent', anchorZh: '移动-agent' },
  Perceiver: { category: 'gameplay', summary: 'Senses nearby perception targets within a sight cone and range.', doc: 'gameplay/ai', anchor: 'perception', anchorZh: '感知' },
  Perception: { category: 'gameplay', summary: "What a perceiver currently sees — written each frame for the entity's own logic to read.", doc: 'gameplay/ai', anchor: 'perception', anchorZh: '感知' },
  PerceptionTarget: { category: 'gameplay', summary: 'Tag: perceivers can see this entity.', doc: 'gameplay/ai', anchor: 'perception', anchorZh: '感知' },
  StateMachineAgent: { category: 'gameplay', summary: 'Runs a gameplay state machine asset, calling registry actions as states enter, update and exit.', doc: 'gameplay/ai', anchor: 'state-machines', anchorZh: '状态机' },
  BehaviorTreeAgent: { category: 'gameplay', summary: 'Ticks a behavior tree asset against a blackboard, calling registry actions at its leaves.', doc: 'gameplay/ai', anchor: 'behavior-trees', anchorZh: '行为树' },
