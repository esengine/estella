...
import type { TileToolStore } from '../store/TileToolStore';
...
export const EDITOR_EVENT_BUS = new ServiceToken<EditorEventBus>('EDITOR_EVENT_BUS');
...
export const SELECTION_STORE = new ServiceToken<SelectionStore>('SELECTION_STORE');
export const TILE_TOOL_STORE = new ServiceToken<TileToolStore>('TILE_TOOL_STORE');
