 ...
 * privileged.
 *
 * It lives HERE, in the declaration module, and not in `main.ts`: the editor
 * imports this file to learn what the project declares, and never the startup
 * one (importing that would run the game). A name registered in `main.ts` works
 * at runtime and is a node the editor cannot draw.
 */
