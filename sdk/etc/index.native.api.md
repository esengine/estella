...
Symbols: 1506 stable · 22 beta · 1 deprecated
...
## NativeGame — interface
```
app: App
config: PackagedGameConfig
```

## NativeGameOptions — interface
```
bridge: NativeBridge
...
## assertHostEnvironment — function
```
(scope?: Record<string, unknown>): void
```

## assertNativeBindings — function
```
(scope?: Record<string, unknown>): void
```

## assertNativeHost — function
```
(scope?: Record<string, unknown>): void
```
