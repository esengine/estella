...
Symbols: 1140 stable · 19 beta · 1 deprecated
...
## AiAction — type
```
(ctx: Ctx, bb: Blackboard) => void | Status
```
...
```
(def: FsmDefinition, name: string, hook: "onEnter" | "onUpdate" | "onExit", action: string): FsmDefinition
```
