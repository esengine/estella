...
Symbols: 1507 stable · 17 beta · 1 deprecated
...
## MiniGameFileSystemManager — interface
```
...
## MiniGameInnerAudioContext — interface
```
currentTime: number
destroy: () => void
duration: number
...
## MiniGameKeyEvent — interface
```
code: string
```

## MiniGamePlatformAdapter — class
```
...
## MiniGameRequestOptions — interface
```
...
## MiniGameRuntimeConfig — interface
```
...
## MiniGameSideModuleFactories — type
```
...
## MiniGameStorageInfo — interface
```
keys: string[]
```

## MiniGameSystemInfo — interface
```
...
## createMiniGameSideModuleHost — function
```
...
## installMiniGamePlatform — function
```
