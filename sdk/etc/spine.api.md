...
Symbols: 0 public · 1 beta · 48 experimental · 0 deprecated
...
## SpineClipBudget — interface @experimental
```
...
observing: boolean
openPreview: (era: SpineEraBinding) => Promise<SpinePreviewInstance | null>
...
## SpinePair — interface @experimental
```
atlas: string
skeleton: string
```
...
## SpinePreviewInstance — interface @experimental
```
