...
Symbols: 1497 stable · 17 beta · 1 deprecated
...
## wxFileExists — function
```
(path: string): Promise<boolean>
```

## wxFileExistsSync — function
```
(path: string): boolean
```

## wxGetImagePixels — function
```
(img: MiniGameImage): ImageLoadResult
```

## wxLoadImage — function
```
(path: string): Promise<MiniGameImage>
```

## wxLoadImagePixels — function
```
