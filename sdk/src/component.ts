...
export const ParticleEmitter = defineBuiltin<ParticleEmitterData>('ParticleEmitter',
    metaDefaults<ParticleEmitterData>('ParticleEmitter'),
    {
        fields: {
            ...
            simulationSpace: { enum: enumOptions(SimulationSpace), advanced: true },
            sizeEasing: { enum: enumOptions(ParticleEasing), advanced: true },
            colorEasing: { enum: enumOptions(ParticleEasing), advanced: true },
            blendMode: { enum: enumOptions(BlendMode) },
            rate: { min: 0 },
            burstCount: { min: 0, step: 1, advanced: true },
            burstInterval: { min: 0, advanced: true },
            playOnStart: { advanced: true },
            maxParticles: { min: 1, step: 1 },
            duration: { min: 0 },
            lifetimeMin: { min: 0 },
            lifetimeMax: { min: 0 },
            shapeRadius: { min: 0, advanced: true },
            shapeAngle: { unit: '°', advanced: true },
            angleSpreadMin: { unit: '°', advanced: true },
            angleSpreadMax: { unit: '°', advanced: true },
            rotationMin: { unit: '°', advanced: true },
            rotationMax: { unit: '°', advanced: true },
            angularVelocityMin: { advanced: true },
            angularVelocityMax: { advanced: true },
            spriteColumns: { min: 1, step: 1, advanced: true },
            spriteRows: { min: 1, step: 1, advanced: true },
            spriteFPS: { min: 0, advanced: true },
            spriteLoop: { advanced: true },
            damping: { min: 0, advanced: true },
            layer: { step: 1, advanced: true },
        },
    }
);
