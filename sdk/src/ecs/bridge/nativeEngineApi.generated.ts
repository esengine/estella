...
export interface NativeEngineApi {
    ...
    meshRenderer_makeResident?(registry: unknown, entity: number): number;
    ...
    meshRenderer_setMesh?(registry: unknown, entity: number, meshHandle: number): void;
...
export function createNativeEngineApi(
    ...
    bind('meshRenderer_makeResident', 'es_meshRenderer_makeResident', true);
    ...
    bind('meshRenderer_setMesh', 'es_meshRenderer_setMesh', true);
