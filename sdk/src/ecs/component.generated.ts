...
export const COMPONENT_META: Record<string, ComponentMetaEntry> = {
    ...
    Camera: {
        ...
        fields: {
            ...
            fov: { min: 1, max: 179, unit: "°", shownWhen: { field: "projectionType", values: [0] } },
            orthoSize: { min: 0, tooltip: "Half the visible height in world units (Orthographic).", shownWhen: { field: "projectionType", values: [1] } },
    ...
    Light: {
        ...
        renderableField: 'enabled',
        assetFields: [{ field: 'cookie', type: 'texture' as AssetFieldType }, { field: 'environment', type: 'environment' as AssetFieldType }],
        entityFields: [],
        colorFields: ['color'],
        animatableFields: ['color.r', 'color.g', 'color.b', 'color.a', 'intensity', 'radius', 'innerRadius', 'falloff', 'shadowStrength', 'cookieSize.x', 'cookieSize.y', 'innerAngle', 'outerAngle', 'shadowSoftness', 'sourceAngle', 'shadowDistance'],
        fields: {
            ...
            cookie: { tooltip: "A texture whose alpha shapes this light (a cookie).", shownWhen: { field: "type", values: [0, 3] } },
            cookieSize: { min: 0, tooltip: "Cookie size in world units; 0 = the light's own reach.", shownWhen: { field: "type", values: [0, 3] } },
            ...
            sourceAngle: { min: 0, max: 90, unit: "°", tooltip: "Angular size of a Directional light's source (the sun is 0.53); 0 = hard edge.", advanced: true, shownWhen: { field: "type", values: [1] } },
    ...
    ParticleEmitter: {
        ...
        fields: {
            ...
            trailWidth: { min: 0, category: "Trail", shownWhen: { field: "trailEnabled", values: [1] } },
            trailPoints: { min: 2, max: 12, step: 1, category: "Trail", shownWhen: { field: "trailEnabled", values: [1] } },
            trailMinDistance: { min: 0, category: "Trail", shownWhen: { field: "trailEnabled", values: [1] } },
            collisionEnabled: { category: "Collision" },
            collisionFloor: { category: "Collision", shownWhen: { field: "collisionEnabled", values: [1] } },
            collisionBounce: { min: 0, max: 1, category: "Collision", shownWhen: { field: "collisionEnabled", values: [1] } },
            collisionFriction: { min: 0, max: 1, category: "Collision", shownWhen: { field: "collisionEnabled", values: [1] } },
            collisionLifetimeLoss: { min: 0, max: 1, category: "Collision", shownWhen: { field: "collisionEnabled", values: [1] } },
        },
    },
    ParticleForceField: {
        defaults: {
    ...
    TilemapLayer: {
        ...
        fields: {
            ...
            hexSideLength: { min: 0, step: 1, tooltip: "Hexagonal side length in px (0 = a regular pointy hex = tileHeight/2). Ignored unless orientation is Hexagonal.", shownWhen: { field: "orientation", values: [3] } },
            staggerAxis: { enum: [{ label: 'Y', value: 0 }, { label: 'X', value: 1 }], tooltip: "Stagger axis (staggered/hex): Y shifts rows, X shifts columns.", shownWhen: { field: "orientation", values: [2, 3] } },
            staggerIndex: { enum: [{ label: 'Odd', value: 0 }, { label: 'Even', value: 1 }], tooltip: "Which lines carry the half-cell shift (staggered/hex).", shownWhen: { field: "orientation", values: [2, 3] } },
