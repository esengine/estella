...
export const PTR_LAYOUTS: Record<string, PtrLayout> = {
    ...
    StateVisuals: {
        ptrFn: 'getStateVisualsPtr',
        fields: [
            { name: 'transitionFlags', type: 'u32', offset: 0 },
            { name: 'fadeDuration', type: 'f32', offset: 4 },
            { name: 'slot0Color', type: 'color', offset: 8 },
            { name: 'slot0Sprite', type: 'u32', offset: 24 },
            { name: 'slot0Scale', type: 'f32', offset: 28 },
            { name: 'slot1Color', type: 'color', offset: 32 },
            { name: 'slot1Sprite', type: 'u32', offset: 48 },
            { name: 'slot1Scale', type: 'f32', offset: 52 },
            { name: 'slot2Color', type: 'color', offset: 56 },
            { name: 'slot2Sprite', type: 'u32', offset: 72 },
            { name: 'slot2Scale', type: 'f32', offset: 76 },
            { name: 'slot3Color', type: 'color', offset: 80 },
            { name: 'slot3Sprite', type: 'u32', offset: 96 },
            { name: 'slot3Scale', type: 'f32', offset: 100 },
            { name: 'slot4Color', type: 'color', offset: 104 },
            { name: 'slot4Sprite', type: 'u32', offset: 120 },
            { name: 'slot4Scale', type: 'f32', offset: 124 },
            { name: 'slot5Color', type: 'color', offset: 128 },
            { name: 'slot5Sprite', type: 'u32', offset: 144 },
            { name: 'slot5Scale', type: 'f32', offset: 148 },
            { name: 'slot6Color', type: 'color', offset: 152 },
            { name: 'slot6Sprite', type: 'u32', offset: 168 },
            { name: 'slot6Scale', type: 'f32', offset: 172 },
            { name: 'slot7Color', type: 'color', offset: 176 },
            { name: 'slot7Sprite', type: 'u32', offset: 192 },
