...
export const PTR_LAYOUTS: Record<string, PtrLayout> = {
    ...
    Light: {
        ...
        fields: [
            ...
            { name: 'innerRadius', type: 'f32', offset: 28 },
            { name: 'falloff', type: 'f32', offset: 32 },
            { name: 'shadowStrength', type: 'f32', offset: 36 },
            { name: 'cookie', type: 'u32', offset: 40 },
            { name: 'cookieSize', type: 'vec2', offset: 44 },
            { name: 'innerAngle', type: 'f32', offset: 52 },
            { name: 'outerAngle', type: 'f32', offset: 56 },
            { name: 'shadowSoftness', type: 'f32', offset: 60 },
            { name: 'sourceAngle', type: 'f32', offset: 64 },
            { name: 'shadowDistance', type: 'f32', offset: 68 },
            { name: 'meshShadows', type: 'bool', offset: 72 },
            { name: 'shadowExtent', type: 'f32', offset: 76 },
            { name: 'environment', type: 'u32', offset: 80 },
            { name: 'environmentRotation', type: 'f32', offset: 84 },
            { name: 'drawEnvironment', type: 'bool', offset: 88 },
    ...
    ParticleEmitter: {
        ...
        fields: [
            ...
            { name: 'shapeSize', type: 'vec3', offset: 40 },
            { name: 'shapeAngle', type: 'f32', offset: 52 },
            { name: 'speedMin', type: 'f32', offset: 56 },
            { name: 'speedMax', type: 'f32', offset: 60 },
            { name: 'angleSpreadMin', type: 'f32', offset: 64 },
            { name: 'angleSpreadMax', type: 'f32', offset: 68 },
            { name: 'startSizeMin', type: 'f32', offset: 72 },
            { name: 'startSizeMax', type: 'f32', offset: 76 },
            { name: 'endSizeMin', type: 'f32', offset: 80 },
            { name: 'endSizeMax', type: 'f32', offset: 84 },
            { name: 'sizeEasing', type: 'i32', offset: 88 },
            { name: 'startColor', type: 'color', offset: 92 },
            { name: 'endColor', type: 'color', offset: 108 },
            { name: 'colorEasing', type: 'i32', offset: 124 },
            { name: 'rotationMin', type: 'f32', offset: 128 },
            { name: 'rotationMax', type: 'f32', offset: 132 },
            { name: 'angularVelocityMin', type: 'f32', offset: 136 },
            { name: 'angularVelocityMax', type: 'f32', offset: 140 },
            { name: 'gravity', type: 'vec3', offset: 144 },
            { name: 'damping', type: 'f32', offset: 156 },
            { name: 'noiseStrength', type: 'f32', offset: 160 },
            { name: 'noiseFrequency', type: 'f32', offset: 164 },
            { name: 'noiseScrollSpeed', type: 'f32', offset: 168 },
            { name: 'noiseOctaves', type: 'i32', offset: 172 },
            { name: 'texture', type: 'u32', offset: 176 },
            { name: 'spriteColumns', type: 'i32', offset: 180 },
            { name: 'spriteRows', type: 'i32', offset: 184 },
            { name: 'spriteFPS', type: 'f32', offset: 188 },
            { name: 'spriteLoop', type: 'bool', offset: 192 },
            { name: 'blendMode', type: 'i32', offset: 196 },
            { name: 'layer', type: 'i32', offset: 200 },
            { name: 'material', type: 'u32', offset: 204 },
            { name: 'simulationSpace', type: 'i32', offset: 208 },
            { name: 'enabled', type: 'bool', offset: 212 },
            { name: 'subEmitterTrigger', type: 'i32', offset: 216 },
            { name: 'subEmitterChance', type: 'f32', offset: 220 },
            { name: 'subEmitterInheritVelocity', type: 'f32', offset: 224 },
            { name: 'subEmitter', type: 'u32', offset: 228 },
            { name: 'trailEnabled', type: 'bool', offset: 232 },
            { name: 'trailWidth', type: 'f32', offset: 236 },
            { name: 'trailPoints', type: 'i32', offset: 240 },
            { name: 'trailMinDistance', type: 'f32', offset: 244 },
            { name: 'collisionEnabled', type: 'bool', offset: 248 },
            { name: 'collisionFloor', type: 'f32', offset: 252 },
            { name: 'collisionBounce', type: 'f32', offset: 256 },
            { name: 'collisionFriction', type: 'f32', offset: 260 },
            { name: 'collisionLifetimeLoss', type: 'f32', offset: 264 },
        ],
    },
    ParticleForceField: {
        ...
        fields: [
            ...
            { name: 'direction', type: 'vec3', offset: 12 },
            { name: 'falloff', type: 'bool', offset: 24 },
            { name: 'enabled', type: 'bool', offset: 25 },
        ],
    },
    RigidBody2D: {
    ...
    Sprite: {
        ...
        fields: [
            ...
            { name: 'order', type: 'i32', offset: 56 },
            { name: 'maskInteraction', type: 'i32', offset: 60 },
            ...
            { name: 'material', type: 'u32', offset: 92 },
            { name: 'enabled', type: 'bool', offset: 96 },
        ],
    },
    SpriteMask: {
        ptrFn: 'getSpriteMaskPtr',
        fields: [
            { name: 'alphaCutoff', type: 'f32', offset: 0 },
            { name: 'limitRange', type: 'bool', offset: 4 },
            { name: 'rangeEndLayer', type: 'i32', offset: 8 },
            { name: 'rangeEndOrder', type: 'i32', offset: 12 },
            { name: 'enabled', type: 'bool', offset: 16 },
        ],
    },
    TilemapLayer: {
