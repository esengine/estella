...
export const PTR_LAYOUTS: Record<string, PtrLayout> = {
    ...
    Light2D: {
        ...
        fields: [
            ...
            { name: 'directionZ', type: 'f32', offset: 36 },
            { name: 'innerAngle', type: 'f32', offset: 40 },
            { name: 'outerAngle', type: 'f32', offset: 44 },
            { name: 'shadowSoftness', type: 'f32', offset: 48 },
            { name: 'shadowDistance', type: 'f32', offset: 52 },
            { name: 'meshShadows', type: 'bool', offset: 56 },
            { name: 'shadowExtent', type: 'f32', offset: 60 },
            { name: 'environment', type: 'u32', offset: 64 },
            { name: 'drawEnvironment', type: 'bool', offset: 68 },
            { name: 'enabled', type: 'bool', offset: 69 },
        ],
    },
    Mesh2D: {
        ptrFn: 'getMesh2DPtr',
