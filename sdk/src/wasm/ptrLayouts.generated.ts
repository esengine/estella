...
export const PTR_LAYOUTS: Record<string, PtrLayout> = {
    ...
    Light: {
        ...
        fields: [
            ...
            { name: 'innerAngle', type: 'f32', offset: 40 },
            { name: 'outerAngle', type: 'f32', offset: 44 },
            { name: 'shadowSoftness', type: 'f32', offset: 48 },
            { name: 'sourceAngle', type: 'f32', offset: 52 },
            { name: 'shadowDistance', type: 'f32', offset: 56 },
            { name: 'meshShadows', type: 'bool', offset: 60 },
            { name: 'shadowExtent', type: 'f32', offset: 64 },
            { name: 'environment', type: 'u32', offset: 68 },
            { name: 'environmentRotation', type: 'f32', offset: 72 },
            { name: 'drawEnvironment', type: 'bool', offset: 76 },
            { name: 'enabled', type: 'bool', offset: 77 },
        ],
    },
    MeshCollider3D: {
