...
export const PTR_LAYOUTS: Record<string, PtrLayout> = {
    ...
    Light2D: {
        ...
        fields: [
            ...
            { name: 'shadowDistance', type: 'f32', offset: 40 },
            { name: 'meshShadows', type: 'bool', offset: 44 },
            { name: 'shadowExtent', type: 'f32', offset: 48 },
            { name: 'environment', type: 'u32', offset: 52 },
            { name: 'drawEnvironment', type: 'bool', offset: 56 },
            { name: 'enabled', type: 'bool', offset: 57 },
        ],
    },
    Mesh2D: {
        ptrFn: 'getMesh2DPtr',
