...
export const PTR_LAYOUTS: Record<string, PtrLayout> = {
    ...
    Sprite: {
        ...
        fields: [
            ...
            { name: 'lit', type: 'bool', offset: 60 },
            { name: 'flipX', type: 'bool', offset: 61 },
            { name: 'flipY', type: 'bool', offset: 62 },
            { name: 'tileSize', type: 'vec2', offset: 64 },
            { name: 'tileSpacing', type: 'vec2', offset: 72 },
            { name: 'parallax', type: 'vec2', offset: 80 },
            { name: 'material', type: 'u32', offset: 88 },
            { name: 'enabled', type: 'bool', offset: 92 },
        ],
    },
