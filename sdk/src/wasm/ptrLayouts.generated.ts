...
export const PTR_LAYOUTS: Record<string, PtrLayout> = {
    ...
    TilemapLayer: {
        ...
        fields: [
            ...
            { name: 'tilesetRows', type: 'i32', offset: 36 },
            { name: 'renderLayer', type: 'i32', offset: 40 },
            { name: 'tintColor', type: 'color', offset: 44 },
            { name: 'opacity', type: 'f32', offset: 60 },
            { name: 'parallaxFactor', type: 'vec2', offset: 64 },
            { name: 'visible', type: 'bool', offset: 72 },
        ],
    },
    TrailRenderer: {
