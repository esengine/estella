 ...
 * @schema_hash  9ffcadb10a7a752e
 */

#define ES_EDITOR_API_SCHEMA_HASH "9ffcadb10a7a752e"
...
bool editor_setInt(Registry& reg, u32 e, const std::string& comp, const std::string& field, i32 value) {
    ...
    if (comp == "BitmapText") {
        ...
        if (!reg.has<esengine::ecs::UINode>(entity)) return false;
        auto& c = reg.get<esengine::ecs::UINode>(entity);
        if (field == "alignSelf") { c.alignSelf = static_cast<AlignSelf>(value); }
        else { return false; }
        return true;
    } else if (comp == "UIRenderer") {
        if (!reg.has<esengine::ecs::UIRenderer>(entity)) return false;
...
i32 editor_getInt(Registry& reg, u32 e, const std::string& comp, const std::string& field) {
    ...
    if (comp == "BitmapText") {
        ...
        const auto& c = reg.get<esengine::ecs::UINode>(entity);
        if (field == "alignSelf") { return static_cast<i32>(c.alignSelf); }
    } else if (comp == "UIRenderer") {
