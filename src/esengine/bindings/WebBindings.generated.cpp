...
static_assert(offsetof(esengine::ecs::Light2D, enabled) == 68, "ABI offset drift: esengine::ecs::Light2D.enabled (EHT expected 68)");
...
static const char* kEsAbiLayoutHash = "ea9373ff870f868a";
