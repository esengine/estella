...
const DISPOSITION = {
  ...
  SphereCollider3D: ['owed', 'physics-3d authors 45 boxes and no other 3D shape; the whole shape family rests on BoxCollider3D'],
  CapsuleCollider3D: ['owed', 'the shape a character body actually uses, and physics-3d authors none'],
  MeshCollider3D: ['owed', 'static level geometry collides against meshes; Jolt ships the single-sided MeshShape and no corpus scene authors one'],
  ConvexCollider3D: ['owed', 'the shape a dynamic prop needs, absent everywhere'],
  ...
  DistanceJoint3D: ['owed', 'physics-3d authors HingeJoint3D alone; four 3D joints ship with no instance anywhere, not even a fixture'],
  FixedJoint3D: ['owed', 'ships with no instance anywhere, not even a fixture'],
  PointJoint3D: ['owed', 'ships with no instance anywhere, not even a fixture'],
  SliderJoint3D: ['owed', 'ships with no instance anywhere, not even a fixture'],
