...
const readers = files
    ...
    // `importer`, not `importer`: the boundary excluded `importerFor`,
    // `importerDefaults`, `applyImporterEdit` — the accessors a setting is read
    // through, and so the files most likely to hold a reader.
