...
export const GATES = [
  ...
  { id: 'project-health', run: 'node tools/check-project-health.mjs' },
  ...
  { id: 'transport-contract', run: 'node tools/check-transport-contract.mjs' },
  ...
  { id: 'health-authority', run: 'node tools/check-health-authority.mjs' },
  ...
  { id: 'mesh-shader-inputs', run: 'node tools/check-mesh-shader-inputs.mjs' },
  { id: 'mesh-instance-record', run: 'node tools/check-mesh-instance-record.mjs' },
  ...
  {
    id: 'script-failure',
    run: 'node tools/check-script-failure.mjs',
    where: 'local',
    why: 'it BOOTS the package it builds, so it needs a real engine runtime and the fast CI'
      + ' lane builds none; the engine-coupled job runs it on the artifact',
  },
