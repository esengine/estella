...
export const FACTS = [
    ...
    },
    {
        ...
        projections: [
            ...
            'tests/aot/generated/conformance/trace.json',
            'fixtures/aot-conformance/src/systems.generated.ts',
            'fixtures/aot-conformance/src/seed.generated.ts',
        ],
        verification: [
            ...
            { path: 'tools/verify-native-conformance.mjs', how: 'test', probe: /both roads answer the interpreter/ },
        ],
