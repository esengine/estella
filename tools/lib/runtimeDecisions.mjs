...
export const DECISIONS = [
  ...
  },
  {
    ...
    editor: { has: true, cite: { path: 'desktop/src/panels/WorldPanel.tsx', probe: /WorldRuntimeStore/ } },
    agent: { has: true, cite: { path: 'desktop/shared/toolCatalog.mjs', probe: /'get_world_residency'/ } },
  },
  {
