...
export const SCENES = [
  ...
  { id: "frame-debugger-split", tier: "pr", webgpu: true, env: { ESTELLA_VERIFY_SCENE: "/scenes/camera-split.esscene", ESTELLA_VERIFY_MANIFEST: "/scenes/camera-split.textures.json", ESTELLA_VERIFY_W: "256", ESTELLA_VERIFY_H: "256", ESTELLA_VERIFY_STEPS: "2", ESTELLA_VERIFY_FRAME_DEBUG: "1" } },
  ...
  // no interaction and must survive, or masking is not opt-in.
  { id: "sprite-mask", tier: "pr", webgpu: true, env: { ESTELLA_VERIFY_SCENE: "/scenes/sprite-mask.esscene", ESTELLA_VERIFY_W: "256", ESTELLA_VERIFY_H: "256", ESTELLA_VERIFY_STEPS: "2", ESTELLA_VERIFY_EXPECT: "[{\"x\":0.25,\"y\":0.5,\"rgb\":[0,255,0],\"tol\":30},{\"x\":0.75,\"y\":0.5,\"rgb\":[255,0,0],\"tol\":30},{\"x\":0.25,\"y\":0.9375,\"rgb\":[0,0,255],\"tol\":30},{\"x\":0.75,\"y\":0.9375,\"rgb\":[0,0,255],\"tol\":30}]" } },
  ...
  // Frame N on screen is cell N — the clip's sheet window reaching Sprite UVs, which
  // no pixel had ever read. Four probes INSIDE one sprite: a window that failed to
  // narrow shows the whole page, so they come back four colours instead of one.
  { id: "sprite-clip-cell0", tier: "pr", webgpu: true, env: { ESTELLA_VERIFY_SCENE: "/scenes/sprite-clip.esscene", ESTELLA_VERIFY_W: "256", ESTELLA_VERIFY_H: "256", ESTELLA_VERIFY_PLAY: "1", ESTELLA_VERIFY_STEPS: "3", ESTELLA_VERIFY_EXPECT: "[{\"x\":0.375,\"y\":0.375,\"rgb\":[255,0,0],\"tol\":30},{\"x\":0.625,\"y\":0.375,\"rgb\":[255,0,0],\"tol\":30},{\"x\":0.375,\"y\":0.625,\"rgb\":[255,0,0],\"tol\":30},{\"x\":0.625,\"y\":0.625,\"rgb\":[255,0,0],\"tol\":30}]" } },
  // Cells 1 and 2 are the two axes of the grid: a sheet cut transposed swaps them
  // and cells 0 and 3 stay put, so a gate on either alone is half blind.
  { id: "sprite-clip-cell1", tier: "pr", webgpu: true, env: { ESTELLA_VERIFY_SCENE: "/scenes/sprite-clip.esscene", ESTELLA_VERIFY_W: "256", ESTELLA_VERIFY_H: "256", ESTELLA_VERIFY_PLAY: "1", ESTELLA_VERIFY_STEPS: "9", ESTELLA_VERIFY_EXPECT: "[{\"x\":0.375,\"y\":0.375,\"rgb\":[0,255,0],\"tol\":30},{\"x\":0.625,\"y\":0.375,\"rgb\":[0,255,0],\"tol\":30},{\"x\":0.375,\"y\":0.625,\"rgb\":[0,255,0],\"tol\":30},{\"x\":0.625,\"y\":0.625,\"rgb\":[0,255,0],\"tol\":30}]" } },
  { id: "sprite-clip-cell2", tier: "pr", webgpu: true, env: { ESTELLA_VERIFY_SCENE: "/scenes/sprite-clip.esscene", ESTELLA_VERIFY_W: "256", ESTELLA_VERIFY_H: "256", ESTELLA_VERIFY_PLAY: "1", ESTELLA_VERIFY_STEPS: "15", ESTELLA_VERIFY_EXPECT: "[{\"x\":0.375,\"y\":0.375,\"rgb\":[0,0,255],\"tol\":30},{\"x\":0.625,\"y\":0.375,\"rgb\":[0,0,255],\"tol\":30},{\"x\":0.375,\"y\":0.625,\"rgb\":[0,0,255],\"tol\":30},{\"x\":0.625,\"y\":0.625,\"rgb\":[0,0,255],\"tol\":30}]" } },
  // Past the end and round again (t = 0.55s of a 0.4s clip). Cell 1 rather than 0:
  // an animator that never advanced would answer cell 0 correctly.
  { id: "sprite-clip-loop", tier: "pr", webgpu: true, env: { ESTELLA_VERIFY_SCENE: "/scenes/sprite-clip.esscene", ESTELLA_VERIFY_W: "256", ESTELLA_VERIFY_H: "256", ESTELLA_VERIFY_PLAY: "1", ESTELLA_VERIFY_STEPS: "33", ESTELLA_VERIFY_EXPECT: "[{\"x\":0.375,\"y\":0.375,\"rgb\":[0,255,0],\"tol\":30},{\"x\":0.625,\"y\":0.375,\"rgb\":[0,255,0],\"tol\":30},{\"x\":0.375,\"y\":0.625,\"rgb\":[0,255,0],\"tol\":30},{\"x\":0.625,\"y\":0.625,\"rgb\":[0,255,0],\"tol\":30}]" } },
  ...
  { id: "skin-fade-start", tier: "pr", env: {"ESTELLA_VERIFY_SCENE": "/scenes/skinned-fade.esscene", "ESTELLA_VERIFY_MANIFEST": "/scenes/skinned-fade.textures.json", "ESTELLA_VERIFY_W": "256", "ESTELLA_VERIFY_H": "256", "ESTELLA_VERIFY_ANIMATOR": "{\"entity\": 1, \"param\": \"bend\", \"value\": 1, \"warmup\": 2, \"frames\": 1}", "ESTELLA_VERIFY_EXPECT": "[{\"x\": 0.3, \"y\": 0.6, \"rgb\": [0, 255, 0], \"tol\": 40}, {\"x\": 0.75, \"y\": 0.6, \"rgb\": [0, 255, 0], \"tol\": 40}, {\"x\": 0.75, \"y\": 0.45, \"rgb\": [0, 0, 0], \"tol\": 25}, {\"x\": 0.45, \"y\": 0.3, \"rgb\": [0, 0, 0], \"tol\": 25}]"} },
  { id: "skin-fade-mid", tier: "pr", env: {"ESTELLA_VERIFY_SCENE": "/scenes/skinned-fade.esscene", "ESTELLA_VERIFY_MANIFEST": "/scenes/skinned-fade.textures.json", "ESTELLA_VERIFY_W": "256", "ESTELLA_VERIFY_H": "256", "ESTELLA_VERIFY_ANIMATOR": "{\"entity\": 1, \"param\": \"bend\", \"value\": 1, \"warmup\": 2, \"frames\": 31}", "ESTELLA_VERIFY_EXPECT": "[{\"x\": 0.3, \"y\": 0.6, \"rgb\": [0, 255, 0], \"tol\": 40}, {\"x\": 0.75, \"y\": 0.6, \"rgb\": [0, 0, 0], \"tol\": 25}, {\"x\": 0.75, \"y\": 0.45, \"rgb\": [0, 255, 0], \"tol\": 40}, {\"x\": 0.45, \"y\": 0.3, \"rgb\": [0, 0, 0], \"tol\": 25}]"} },
  { id: "skin-fade-end", tier: "pr", env: {"ESTELLA_VERIFY_SCENE": "/scenes/skinned-fade.esscene", "ESTELLA_VERIFY_MANIFEST": "/scenes/skinned-fade.textures.json", "ESTELLA_VERIFY_W": "256", "ESTELLA_VERIFY_H": "256", "ESTELLA_VERIFY_ANIMATOR": "{\"entity\": 1, \"param\": \"bend\", \"value\": 1, \"warmup\": 2, \"frames\": 90}", "ESTELLA_VERIFY_EXPECT": "[{\"x\": 0.3, \"y\": 0.6, \"rgb\": [0, 255, 0], \"tol\": 40}, {\"x\": 0.75, \"y\": 0.6, \"rgb\": [0, 0, 0], \"tol\": 25}, {\"x\": 0.75, \"y\": 0.45, \"rgb\": [0, 0, 0], \"tol\": 25}, {\"x\": 0.45, \"y\": 0.3, \"rgb\": [0, 255, 0], \"tol\": 40}]"} },
  ...
  // A CONE casting, through the tile and the pass a cascade uses. The shadow is offset
  ...
  // above what it falls on.

  // The whole ramp, not just its ends: what the probes pin is the SHAPE of that penumbra,
  // which is where a sun of the wrong angular size shows. One expectation for every
  // rasterizer — webgl2, webgpu and SwiftShader read these to the value.
  { id: "sun-shadow", tier: "pr", webgpu: true, env: { ESTELLA_VERIFY_SCENE: "/scenes/sun-shadow.esscene", ESTELLA_VERIFY_W: "256", ESTELLA_VERIFY_H: "256", ESTELLA_VERIFY_STEPS: "2", ESTELLA_VERIFY_EXPECT: "[{\"x\":0.62,\"y\":0.5,\"rgb\":[0,0,0],\"tol\":20},{\"x\":0.66,\"y\":0.5,\"rgb\":[70,70,70],\"tol\":10},{\"x\":0.68,\"y\":0.5,\"rgb\":[116,116,116],\"tol\":10},{\"x\":0.7,\"y\":0.5,\"rgb\":[170,170,170],\"tol\":10},{\"x\":0.72,\"y\":0.5,\"rgb\":[209,209,209],\"tol\":10},{\"x\":0.85,\"y\":0.5,\"rgb\":[247,247,247],\"tol\":20}]" } },
  ...
  { id: "sun-shadow-contact", tier: "pr", webgpu: true, env: { ESTELLA_VERIFY_SCENE: "/scenes/sun-shadow-contact.esscene", ESTELLA_VERIFY_W: "256", ESTELLA_VERIFY_H: "256", ESTELLA_VERIFY_STEPS: "2", ESTELLA_VERIFY_EXPECT: "[{\"x\":0.62,\"y\":0.5,\"rgb\":[0,0,0],\"tol\":20},{\"x\":0.66,\"y\":0.5,\"rgb\":[0,0,0],\"tol\":20},{\"x\":0.72,\"y\":0.5,\"rgb\":[247,247,247],\"tol\":25},{\"x\":0.85,\"y\":0.5,\"rgb\":[247,247,247],\"tol\":20}]" } },
  // A SOURCE WITH SIZE. The light's half-extent, the blocker's distance from it and the
  // receiver's are the whole penumbra, so these probes read a soft edge here and a hard
  // one in the gate below, where the same scene's caster stands near what it falls on.
  { id: "soft-shadow", tier: "pr", webgpu: true, env: { ESTELLA_VERIFY_SCENE: "/scenes/soft-shadow.esscene", ESTELLA_VERIFY_W: "256", ESTELLA_VERIFY_H: "256", ESTELLA_VERIFY_STEPS: "2", ESTELLA_VERIFY_EXPECT: "[{\"x\":0.73,\"y\":0.5,\"rgb\":[0,0,0],\"tol\":20},{\"x\":0.759,\"y\":0.5,\"rgb\":[0,0,0],\"tol\":20},{\"x\":0.833,\"y\":0.5,\"rgb\":[75,75,75],\"tol\":45},{\"x\":0.9,\"y\":0.5,\"rgb\":[158,158,158],\"tol\":25}]" } },
  // The same scene with the caster moved DOWN the light's own ray: its shadow lands where
  // it did and the edge sharpens by the ratio of the two distances. A fixed blur would
  // read the same in both gates, and one that ignores the source's size neither.
  { id: "soft-shadow-contact", tier: "pr", webgpu: true, env: { ESTELLA_VERIFY_SCENE: "/scenes/soft-shadow-contact.esscene", ESTELLA_VERIFY_W: "256", ESTELLA_VERIFY_H: "256", ESTELLA_VERIFY_STEPS: "2", ESTELLA_VERIFY_EXPECT: "[{\"x\":0.745,\"y\":0.5,\"rgb\":[0,0,0],\"tol\":20},{\"x\":0.759,\"y\":0.5,\"rgb\":[85,85,85],\"tol\":55},{\"x\":0.77,\"y\":0.5,\"rgb\":[180,180,180],\"tol\":25},{\"x\":0.833,\"y\":0.5,\"rgb\":[170,170,170],\"tol\":25}]" } },
  // The same scene stepped far enough to leave a deep queue behind it: on the second
  // backend the copy of the frame lands about 2.7 seconds after it is asked for, so this
  // is the gate that says waiting for one is bounded by the device, not by a poll count.
  { id: "point-shadow-stepped", tier: "pr", webgpu: true, env: { ESTELLA_VERIFY_SCENE: "/scenes/point-shadow.esscene", ESTELLA_VERIFY_W: "256", ESTELLA_VERIFY_H: "256", ESTELLA_VERIFY_STEPS: "64", ESTELLA_VERIFY_EXPECT: "[{\"x\":0.167,\"y\":0.5,\"rgb\":[0,0,0],\"tol\":20},{\"x\":0.5,\"y\":0.833,\"rgb\":[0,0,0],\"tol\":20},{\"x\":0.5,\"y\":0.5,\"rgb\":[242,242,242],\"tol\":20}]" } },
  ...
  // A PAIR differing in ONE field: nine cubes behind a wall an Occluder declares
  // solid, two beside it. Three draws here, twelve with that field off below — and
  // the SAME four pixels, which is the whole claim about what an occluder changes.
  { id: "occlusion-cull", tier: "pr", webgpu: true, env: { ESTELLA_VERIFY_SCENE: "/scenes/occlusion-cost.esscene", ESTELLA_VERIFY_W: "256", ESTELLA_VERIFY_H: "256", ESTELLA_VERIFY_STEPS: "2", ESTELLA_VERIFY_COUNTERS: "{\"render.meshes\": 3, \"render.culled\": 9, \"render.cull.occluded\": 9, \"render.cull.occluders\": 1}", ESTELLA_VERIFY_EXPECT: "[{\"x\": 0.5, \"y\": 0.5, \"rgb\": [255, 255, 255], \"tol\": 20}, {\"x\": 0.918, \"y\": 0.5, \"rgb\": [0, 255, 0], \"tol\": 30}, {\"x\": 0.082, \"y\": 0.5, \"rgb\": [0, 255, 0], \"tol\": 30}, {\"x\": 0.98, \"y\": 0.02, \"rgb\": [0, 0, 0], \"tol\": 10}]" } },
  { id: "occlusion-off", tier: "pr", webgpu: true, env: { ESTELLA_VERIFY_SCENE: "/scenes/occlusion-cost.esscene", ESTELLA_VERIFY_W: "256", ESTELLA_VERIFY_H: "256", ESTELLA_VERIFY_STEPS: "2", ESTELLA_VERIFY_SET_FIELD: "{\"entity\": 1, \"component\": \"Occluder\", \"key\": \"enabled\", \"value\": false, \"steps\": 2}", ESTELLA_VERIFY_COUNTERS: "{\"render.meshes\": 12, \"render.culled\": 0, \"render.cull.occluded\": 0, \"render.cull.occluders\": 0}", ESTELLA_VERIFY_EXPECT: "[{\"x\": 0.5, \"y\": 0.5, \"rgb\": [255, 255, 255], \"tol\": 20}, {\"x\": 0.918, \"y\": 0.5, \"rgb\": [0, 255, 0], \"tol\": 30}, {\"x\": 0.082, \"y\": 0.5, \"rgb\": [0, 255, 0], \"tol\": 30}, {\"x\": 0.98, \"y\": 0.02, \"rgb\": [0, 0, 0], \"tol\": 10}]" } },
  ...
  // The sky from the editor eye. Level is where a quad on the far plane rounded past
  // it and was clipped whole; down and up hold which half is which. The editor's own
  // sweep (desktop editor check sky-angles) covers the angles this eye does not.
  { id: "sky-eye-down", tier: "pr", webgpu: true, env: { ESTELLA_VERIFY_SCENE: "/scenes/mesh-sky.esscene", ESTELLA_VERIFY_W: "256", ESTELLA_VERIFY_H: "256", ESTELLA_VERIFY_STEPS: "2", ESTELLA_VERIFY_PERSPECTIVE: "1", ESTELLA_VERIFY_ORBIT: "0,60", ESTELLA_VERIFY_UNIFORM: "1", ESTELLA_VERIFY_COUNT: "[{\"rgb\":[153,0,0],\"tol\":48,\"atLeast\":60000}]" } },
  { id: "sky-eye-up", tier: "pr", webgpu: true, env: { ESTELLA_VERIFY_SCENE: "/scenes/mesh-sky.esscene", ESTELLA_VERIFY_W: "256", ESTELLA_VERIFY_H: "256", ESTELLA_VERIFY_STEPS: "2", ESTELLA_VERIFY_PERSPECTIVE: "1", ESTELLA_VERIFY_ORBIT: "0,-60", ESTELLA_VERIFY_UNIFORM: "1", ESTELLA_VERIFY_COUNT: "[{\"rgb\":[0,0,153],\"tol\":48,\"atLeast\":60000}]" } },
  { id: "sky-eye-level", tier: "pr", webgpu: true, env: { ESTELLA_VERIFY_SCENE: "/scenes/mesh-sky.esscene", ESTELLA_VERIFY_W: "256", ESTELLA_VERIFY_H: "256", ESTELLA_VERIFY_STEPS: "2", ESTELLA_VERIFY_PERSPECTIVE: "1", ESTELLA_VERIFY_ORBIT: "180,0", ESTELLA_VERIFY_COUNT: "[{\"rgb\":[0,0,153],\"tol\":48,\"atLeast\":6000},{\"rgb\":[153,0,0],\"tol\":48,\"atLeast\":2500}]" } },
  ...
  // fixture is half bright — a symmetric sky reads the same at every angle.
  { id: "sky-azimuth", tier: "pr", webgpu: false, env: { ESTELLA_VERIFY_SCENE: "/scenes/sky-azimuth.esscene", ESTELLA_VERIFY_W: "256", ESTELLA_VERIFY_H: "256", ESTELLA_VERIFY_STEPS: "2", ESTELLA_VERIFY_EXPECT: "[{\"x\":0.1,\"y\":0.5,\"rgb\":[255,14,14],\"tol\":24},{\"x\":0.5,\"y\":0.5,\"rgb\":[145,9,9],\"tol\":24},{\"x\":0.9,\"y\":0.5,\"rgb\":[5,5,5],\"tol\":18}]" } },
  { id: "sky-azimuth-turned", tier: "pr", webgpu: false, env: { ESTELLA_VERIFY_SCENE: "/scenes/sky-azimuth.esscene", ESTELLA_VERIFY_W: "256", ESTELLA_VERIFY_H: "256", ESTELLA_VERIFY_STEPS: "2", ESTELLA_VERIFY_SET_FIELD: "{\"entity\":1,\"component\":\"Light\",\"key\":\"environmentRotation\",\"value\":-20}", ESTELLA_VERIFY_EXPECT: "[{\"x\":0.1,\"y\":0.5,\"rgb\":[255,14,14],\"tol\":24},{\"x\":0.5,\"y\":0.5,\"rgb\":[255,14,14],\"tol\":24},{\"x\":0.9,\"y\":0.5,\"rgb\":[5,5,5],\"tol\":18}]" } },
  { id: "diffuse-azimuth", tier: "pr", webgpu: true, env: { ESTELLA_VERIFY_SCENE: "/scenes/diffuse-azimuth.esscene", ESTELLA_VERIFY_W: "256", ESTELLA_VERIFY_H: "256", ESTELLA_VERIFY_STEPS: "2", ESTELLA_VERIFY_EXPECT: "[{\"x\":0.25,\"y\":0.5,\"rgb\":[157,10,10],\"tol\":24},{\"x\":0.75,\"y\":0.5,\"rgb\":[157,10,10],\"tol\":24}]" } },
  { id: "diffuse-azimuth-turned", tier: "pr", webgpu: true, env: { ESTELLA_VERIFY_SCENE: "/scenes/diffuse-azimuth.esscene", ESTELLA_VERIFY_W: "256", ESTELLA_VERIFY_H: "256", ESTELLA_VERIFY_STEPS: "2", ESTELLA_VERIFY_SET_FIELD: "{\"entity\":1,\"component\":\"Light\",\"key\":\"environmentRotation\",\"value\":90}", ESTELLA_VERIFY_EXPECT: "[{\"x\":0.25,\"y\":0.5,\"rgb\":[255,14,14],\"tol\":24},{\"x\":0.75,\"y\":0.5,\"rgb\":[255,14,14],\"tol\":24}]" } },  // A glTF animation, through the shipped importer. The scene puts the quad at
  ...
  // A HUD over a PERSPECTIVE camera. That view has no world rectangle, so a
  // layout box taken from a camera resolves every HUD element to 0x0 and the two
  // corners here come back black.
  { id: "ui-screen-3d", tier: "pr", webgpu: true, env: { ESTELLA_VERIFY_PLAY: "1", ESTELLA_VERIFY_SCENE: "/scenes/ui-screen-3d.esscene", ESTELLA_VERIFY_MANIFEST: "/scenes/ui-screen-3d.textures.json", ESTELLA_VERIFY_W: "640", ESTELLA_VERIFY_H: "360", ESTELLA_VERIFY_STEPS: "4", ESTELLA_VERIFY_EXPECT: "[{\"x\": 0.25, \"y\": 0.25, \"rgb\": [255, 0, 0], \"tol\": 30}, {\"x\": 0.75, \"y\": 0.75, \"rgb\": [0, 255, 0], \"tol\": 30}, {\"x\": 0.75, \"y\": 0.25, \"rgb\": [0, 0, 255], \"tol\": 40}, {\"x\": 0.25, \"y\": 0.75, \"rgb\": [0, 0, 0], \"tol\": 30}]" } },
  // ...and the camera leaves. The world blob goes with it — the control, without
  // which this would pass on a frame where nothing moved — and the two corners
  // stay exactly where they were.
  { id: "ui-screen-3d-camera-moved", tier: "pr", webgpu: true, env: { ESTELLA_VERIFY_PLAY: "1", ESTELLA_VERIFY_SCENE: "/scenes/ui-screen-3d.esscene", ESTELLA_VERIFY_MANIFEST: "/scenes/ui-screen-3d.textures.json", ESTELLA_VERIFY_W: "640", ESTELLA_VERIFY_H: "360", ESTELLA_VERIFY_STEPS: "4", ESTELLA_VERIFY_MOVE: "{\"component\": \"Camera\", \"to\": [4000, 1000], \"steps\": 4}", ESTELLA_VERIFY_EXPECT: "[{\"x\": 0.25, \"y\": 0.25, \"rgb\": [255, 0, 0], \"tol\": 30}, {\"x\": 0.75, \"y\": 0.75, \"rgb\": [0, 255, 0], \"tol\": 30}, {\"x\": 0.75, \"y\": 0.25, \"rgb\": [0, 0, 0], \"tol\": 30}, {\"x\": 0.25, \"y\": 0.75, \"rgb\": [0, 0, 0], \"tol\": 30}]" } },
  // What a screen element's z may decide, which is nothing. Three roots carry
  // z -10000 / 0 / +10000 and all three must draw; a fourth, LATER sibling with
  // the furthest z of all covers the first, because the tree orders a screen.
  { id: "ui-screen-order", tier: "pr", webgpu: true, env: { ESTELLA_VERIFY_PLAY: "1", ESTELLA_VERIFY_SCENE: "/scenes/ui-screen-order.esscene", ESTELLA_VERIFY_MANIFEST: "/scenes/ui-screen-order.textures.json", ESTELLA_VERIFY_W: "640", ESTELLA_VERIFY_H: "360", ESTELLA_VERIFY_STEPS: "4", ESTELLA_VERIFY_EXPECT: "[{\"x\": 0.16, \"y\": 0.1, \"rgb\": [255, 0, 0], \"tol\": 30}, {\"x\": 0.5, \"y\": 0.5, \"rgb\": [0, 255, 0], \"tol\": 30}, {\"x\": 0.83, \"y\": 0.5, \"rgb\": [0, 0, 255], \"tol\": 30}, {\"x\": 0.16, \"y\": 0.5, \"rgb\": [255, 255, 255], \"tol\": 30}]" } },
  // Where the overlay sits, which is after the post chain. A vignette crushes
  // the WORLD quad to black a third of the way in (the two black points are the
  // control) while the badge in the very corner keeps the red it was authored.
  { id: "ui-screen-post", tier: "pr", webgpu: true, env: { ESTELLA_VERIFY_PLAY: "1", ESTELLA_VERIFY_SCENE: "/scenes/ui-screen-post.esscene", ESTELLA_VERIFY_MANIFEST: "/scenes/ui-screen-post.textures.json", ESTELLA_VERIFY_W: "640", ESTELLA_VERIFY_H: "360", ESTELLA_VERIFY_STEPS: "4", ESTELLA_VERIFY_EXPECT: "[{\"x\": 0.03, \"y\": 0.03, \"rgb\": [255, 0, 0], \"tol\": 6}, {\"x\": 0.3, \"y\": 0.03, \"rgb\": [0, 0, 0], \"tol\": 6}, {\"x\": 0.97, \"y\": 0.97, \"rgb\": [0, 0, 0], \"tol\": 6}, {\"x\": 0.5, \"y\": 0.5, \"rgb\": [51, 153, 255], \"tol\": 10}]" } },
  // HUD TEXT, which the SDK submits itself — the one screen primitive that could
  ...
  // Asked as HOW MUCH yellow, not where: which stroke covers x=0.4 is a fact
  // about the runner's fonts, and probes at named strokes read the panel on
  // Linux while the text was drawn. 13282 pixels here; the floor of 2000 stands.
  { id: "ui-screen-text", tier: "pr", webgpu: true, env: { ESTELLA_VERIFY_PLAY: "1", ESTELLA_VERIFY_SCENE: "/scenes/ui-screen-text.esscene", ESTELLA_VERIFY_MANIFEST: "/scenes/ui-screen-text.textures.json", ESTELLA_VERIFY_W: "640", ESTELLA_VERIFY_H: "360", ESTELLA_VERIFY_STEPS: "6", ESTELLA_VERIFY_EXPECT: "[{\"x\": 0.05, \"y\": 0.5, \"rgb\": [0, 0, 153], \"tol\": 40}]", ESTELLA_VERIFY_COUNT: "[{\"rgb\": [255, 255, 0], \"tol\": 40, \"atLeast\": 2000}]" } },
  ...
  // needs. The PAIR is the gate: `-off` asserts the measurement still finds one.
  ...
  { id: "trail", tier: "pr", webgpu: true, env: { ESTELLA_VERIFY_PLAY: "1", ESTELLA_VERIFY_SCENE: "/scenes/trail.esscene", ESTELLA_VERIFY_MANIFEST: "/scenes/trail.textures.json", ESTELLA_VERIFY_W: "256", ESTELLA_VERIFY_H: "256", ESTELLA_VERIFY_TRAIL: "{\"from\":[-200,0],\"to\":[200,0],\"steps\":20}", ESTELLA_VERIFY_EXPECT: "[{\"x\":0.80,\"y\":0.5,\"rgb\":[0,255,0],\"tol\":50},{\"x\":0.5,\"y\":0.5,\"rgb\":[0,255,0],\"tol\":50},{\"x\":0.25,\"y\":0.5,\"rgb\":[0,255,0],\"tol\":60},{\"x\":0.5,\"y\":0.15,\"rgb\":[0,0,0],\"tol\":30}]" } },
    // A ribbon whose path runs through depth. Measured both ways: per-point z spans
    // x 0.20-0.65, flattened onto the head's plane only 0.40-0.60 — hence two left
    // probes, and none at the head, the plane a flat ribbon collapses ONTO.
  { id: "trail-depth", tier: "pr", webgpu: true, env: { ESTELLA_VERIFY_PLAY: "1", ESTELLA_VERIFY_SCENE: "/scenes/trail-depth.esscene", ESTELLA_VERIFY_MANIFEST: "/scenes/trail-depth.textures.json", ESTELLA_VERIFY_W: "256", ESTELLA_VERIFY_H: "256", ESTELLA_VERIFY_TRAIL: "{\"from\":[-200,0,0],\"to\":[200,0,-400],\"steps\":20}", ESTELLA_VERIFY_EXPECT: "[{\"x\": 0.22, \"y\": 0.5, \"rgb\": [0, 255, 0], \"tol\": 50}, {\"x\": 0.3, \"y\": 0.5, \"rgb\": [0, 255, 0], \"tol\": 50}, {\"x\": 0.5, \"y\": 0.5, \"rgb\": [0, 255, 0], \"tol\": 50}, {\"x\": 0.8, \"y\": 0.5, \"rgb\": [0, 0, 0], \"tol\": 30}, {\"x\": 0.5, \"y\": 0.3, \"rgb\": [0, 0, 0], \"tol\": 30}]" } },
  ...
  { id: "output-aces", tier: "pr", webgpu: true, env: { ESTELLA_VERIFY_SCENE: "/scenes/srgb-midtone.esscene", ESTELLA_VERIFY_MANIFEST: "/scenes/srgb-midtone.textures.json", ESTELLA_VERIFY_W: "256", ESTELLA_VERIFY_H: "256", ESTELLA_VERIFY_STEPS: "2", ESTELLA_VERIFY_OUTPUT_TRANSFORM: "aces", ESTELLA_VERIFY_EXPECT: "[{\"x\":0.5,\"y\":0.5,\"rgb\":[157,157,157],\"tol\":4}]" } },
  // The same curve in linear light: 0.502 decodes to 0.2158, ACES maps it to
  // 0.3242, the OETF encodes that to 154. Applied ONCE — twice would read 182,
  // and linear-midtone beside this one reads 128 with no transform at all.
  { id: "output-aces-linear", tier: "pr", webgpu: true, env: { ESTELLA_VERIFY_SCENE: "/scenes/srgb-midtone.esscene", ESTELLA_VERIFY_MANIFEST: "/scenes/srgb-midtone.textures.json", ESTELLA_VERIFY_W: "256", ESTELLA_VERIFY_H: "256", ESTELLA_VERIFY_STEPS: "2", ESTELLA_VERIFY_COLORSPACE: "linear", ESTELLA_VERIFY_OUTPUT_TRANSFORM: "aces", ESTELLA_VERIFY_EXPECT: "[{\"x\":0.5,\"y\":0.5,\"rgb\":[154,154,154],\"tol\":4}]" } },
  ...
  // The other skeletal runtime, on the same terms as spine below it: a side
  // module that quietly stops drawing looks exactly like one that never ran, and
  // spine had a scene here while dragonbones had only a device smoke.
  { id: "dragonbones", tier: "pr", webgpu: true, rendersOnly: "a skeleton has no interior flat enough to name a point in — the claim is that it reached the frame at all", env: { ESTELLA_VERIFY_SCENE: "/scenes/dragonbones-test.esscene", ESTELLA_VERIFY_MANIFEST: "/scenes/dragonbones-test.textures.json", ESTELLA_VERIFY_W: "256", ESTELLA_VERIFY_H: "256" } },
  ...
  // A camera 300 to the side, turned to look back down world -X at ONE particle.
  ...
  { id: "particles-trail", tier: "pr", webgpu: true, rendersOnly: "seeded and reproducible, but a ribbon of moving comets has no flat region a probe survives", env: { ESTELLA_VERIFY_PLAY: "1", ESTELLA_VERIFY_SCENE: "/scenes/particle-trail.esscene", ESTELLA_VERIFY_MANIFEST: "/scenes/particle-trail.textures.json", ESTELLA_VERIFY_STEPS: "60", ESTELLA_VERIFY_SEED: "1234" } },
  { id: "particles-collision", tier: "pr", webgpu: true, rendersOnly: "sparks bouncing off a floor plane are in motion at every step a probe could read", env: { ESTELLA_VERIFY_PLAY: "1", ESTELLA_VERIFY_SCENE: "/scenes/particle-collision.esscene", ESTELLA_VERIFY_MANIFEST: "/scenes/particle-collision.textures.json", ESTELLA_VERIFY_STEPS: "70", ESTELLA_VERIFY_SEED: "1234" } },
  { id: "particles-forcefield", tier: "pr", webgpu: true, rendersOnly: "a vortex keeps every particle moving, so no cell settles", env: { ESTELLA_VERIFY_PLAY: "1", ESTELLA_VERIFY_SCENE: "/scenes/particle-forcefield.esscene", ESTELLA_VERIFY_MANIFEST: "/scenes/particle-forcefield.textures.json", ESTELLA_VERIFY_STEPS: "80", ESTELLA_VERIFY_SEED: "1234" } },
  ...
  // A wall laid at 60 degrees. Its shadow leans with it: the probe below the
  ...
  // Red at the centre exists only if a camera rendered into a texture: the fill
  // sits on a layer the screen camera culls, and the screen sprite wears that
  // target. webgl2 only — on WebGPU the frame readback returns nothing when one
  // frame holds both an offscreen and a surface pass.
  { id: "camera-render-target", tier: "pr", env: { ESTELLA_VERIFY_SCENE: "/scenes/camera-target.esscene", ESTELLA_VERIFY_MANIFEST: "/scenes/camera-target.textures.json", ESTELLA_VERIFY_CAMERA_TARGET: "{\"camera\":0,\"sprite\":3,\"width\":128,\"height\":128}", ESTELLA_VERIFY_W: "256", ESTELLA_VERIFY_H: "256", ESTELLA_VERIFY_STEPS: "4", ESTELLA_VERIFY_EXPECT: "[{\"x\":0.5,\"y\":0.5,\"rgb\":[255,0,0],\"tol\":40}]" } },
  ...
  // mesh-renderer's scene and assertions, with its geometry frozen onto the GPU mid-run.
  ...
  // A GENERATED twin on a mesh. A generated vertex stage is frozen at the batch
  // source, so WebGPU refused the pipeline; the two halves read the uv varying.
  { id: "mat-generated-mesh", tier: "pr", webgpu: true, env: { ESTELLA_VERIFY_SCENE: "/scenes/mat-generated-mesh.esscene", ESTELLA_VERIFY_W: "256", ESTELLA_VERIFY_H: "256", ESTELLA_VERIFY_STEPS: "4", ESTELLA_VERIFY_EXPECT: "[{\"x\":0.3,\"y\":0.5,\"rgb\":[255,0,0],\"tol\":40},{\"x\":0.7,\"y\":0.5,\"rgb\":[0,255,0],\"tol\":40}]" } },
  ...
  { id: "mesh-preview", tier: "pr", host: "editor", webgpu: true, env: { ESTELLA_VERIFY_MESH_PREVIEW: "{\"w\":128,\"h\":128}", ESTELLA_VERIFY_SCENE: "/scenes/mesh-lit.esscene", ESTELLA_VERIFY_MANIFEST: "/scenes/mesh-lit.textures.json", ESTELLA_VERIFY_W: "256", ESTELLA_VERIFY_H: "256", ESTELLA_VERIFY_STEPS: "4" } },
  ...
  { id: "mesh-assign", tier: "pr", host: "editor", webgpu: true, env: { ESTELLA_VERIFY_SET_FIELD: "{\"entity\":1,\"component\":\"MeshRenderer\",\"key\":\"mesh\",\"value\":\"/scenes/textured-quad.esmesh\"}", ESTELLA_VERIFY_PICK: "{\"x\":0.7,\"y\":0.3833,\"entity\":1}", ESTELLA_VERIFY_SCENE: "/scenes/mesh-renderer.esscene", ESTELLA_VERIFY_MANIFEST: "/scenes/mesh-renderer.textures.json", ESTELLA_VERIFY_W: "256", ESTELLA_VERIFY_H: "256", ESTELLA_VERIFY_STEPS: "4", ESTELLA_VERIFY_EXPECT: "[{\"x\":0.5,\"y\":0.5,\"rgb\":[255,255,255],\"tol\":40},{\"x\":0.30,\"y\":0.556,\"rgb\":[255,255,255],\"tol\":40}]" } },
  ...
  { id: "view-orbit", tier: "pr", host: "editor", webgpu: true, env: { ESTELLA_VERIFY_ORBIT: "60,0", ESTELLA_VERIFY_PICK: "{\"x\":0.40,\"y\":0.556,\"entity\":1}", ESTELLA_VERIFY_SCENE: "/scenes/mesh-renderer.esscene", ESTELLA_VERIFY_MANIFEST: "/scenes/mesh-renderer.textures.json", ESTELLA_VERIFY_W: "256", ESTELLA_VERIFY_H: "256", ESTELLA_VERIFY_STEPS: "4", ESTELLA_VERIFY_EXPECT: "[{\"x\":0.40,\"y\":0.556,\"rgb\":[255,0,0],\"tol\":40},{\"x\":0.60,\"y\":0.556,\"rgb\":[0,255,0],\"tol\":40},{\"x\":0.30,\"y\":0.556,\"rgb\":[0,0,0],\"tol\":30}]" } },
  ...
  { id: "sort-view-depth", tier: "pr", host: "editor", webgpu: true, env: { ESTELLA_VERIFY_ORBIT: "-60,0", ESTELLA_VERIFY_SCENE: "/scenes/sort-view-depth.esscene", ESTELLA_VERIFY_MANIFEST: "/scenes/sort-view-depth.textures.json", ESTELLA_VERIFY_W: "256", ESTELLA_VERIFY_H: "256", ESTELLA_VERIFY_STEPS: "4", ESTELLA_VERIFY_EXPECT: "[{\"x\":0.5,\"y\":0.5,\"rgb\":[0,255,0],\"tol\":40},{\"x\":0.30,\"y\":0.5,\"rgb\":[0,255,0],\"tol\":40},{\"x\":0.70,\"y\":0.5,\"rgb\":[255,0,0],\"tol\":40}]" } },
  // A sprite at z = +1 under an ortho camera at z = 0: inside the symmetric box the
  // engine builds, and below 0 of what WebGPU keeps. Both backends draw it only while
  // updateCameraConstants converts the projection into the clip volume each one has.
  { id: "ortho-clip-behind-camera", tier: "pr", webgpu: true, env: { ESTELLA_VERIFY_SCENE: "/scenes/ortho-clip-behind-camera.esscene", ESTELLA_VERIFY_MANIFEST: "/scenes/ortho-clip-behind-camera.textures.json", ESTELLA_VERIFY_W: "256", ESTELLA_VERIFY_H: "256", ESTELLA_VERIFY_STEPS: "4", ESTELLA_VERIFY_EXPECT: "[{\"x\":0.30,\"y\":0.5,\"rgb\":[255,0,0],\"tol\":40},{\"x\":0.70,\"y\":0.5,\"rgb\":[0,255,0],\"tol\":40}]" } },
  ...
  // The first two points are on the SAME flat wall at one constant depth, where
  // a 90-degree eye is 1.41x further from the frame's edge than from its centre:
  // an effect reading depth paints them alike, and tol 10 does not reach between.
  { id: "distance-fog", tier: "pr", webgpu: true, env: { ESTELLA_VERIFY_SCENE: "/scenes/distance-fog.esscene", ESTELLA_VERIFY_MANIFEST: "/scenes/depth-outline.textures.json", ESTELLA_VERIFY_W: "256", ESTELLA_VERIFY_H: "256", ESTELLA_VERIFY_STEPS: "4", ESTELLA_VERIFY_EXPECT: "[{\"x\": 0.5, \"y\": 0.5, \"rgb\": [107, 176, 143], \"tol\": 10}, {\"x\": 0.0625, \"y\": 0.5, \"rgb\": [134, 174, 176], \"tol\": 10}, {\"x\": 0.4375, \"y\": 0.5, \"rgb\": [190, 85, 92], \"tol\": 14}, {\"x\": 0.6875, \"y\": 0.5, \"rgb\": [200, 60, 62], \"tol\": 14}]" } },
  // SSAO: one unlit grey floor read at seven places. Contact, corner and
  // step come back darker than the open floor they are made of, the floating
  // box does not, and the wall behind a silhouette keeps its colour.
  // Every tolerance is set against how far its point MOVES with the effect off:
  // the corner travels 49 and the step 47, so 22 and 20 still read the absence,
  // while the shallow face at 0.627 travels 19 and keeps a tight 9.
  // A quad turned 20 degrees on black, read twice: the SAME values with and
  // without a post chain is the claim. WebGPU has no MSAA yet, so both its
  // halves read the hard step — still the claim, that the chain changes nothing.
  { id: "aa-edge", tier: "pr", webgpu: true, env: { ESTELLA_VERIFY_SCENE: "/scenes/aa-edge.esscene", ESTELLA_VERIFY_W: "256", ESTELLA_VERIFY_H: "256", ESTELLA_VERIFY_STEPS: "2", ESTELLA_VERIFY_EXPECT: "[{\"x\":0.2353,\"y\":0.502,\"rgb\":[128,128,128],\"tol\":64},{\"x\":0.2392,\"y\":0.502,\"rgb\":[128,128,128],\"tol\":64},{\"x\":0.749,\"y\":0.502,\"rgb\":[128,128,128],\"tol\":64},{\"x\":0.7529,\"y\":0.502,\"rgb\":[128,128,128],\"tol\":64},{\"x\":0.502,\"y\":0.502,\"rgb\":[255,255,255],\"tol\":6},{\"x\":0.0784,\"y\":0.0784,\"rgb\":[0,0,0],\"tol\":6}]" } },
  // The other half: the same edges, read through an identity post chain.
    { id: "aa-edge-post", tier: "pr", webgpu: true, env: { ESTELLA_VERIFY_SCENE: "/scenes/aa-edge-post.esscene", ESTELLA_VERIFY_W: "256", ESTELLA_VERIFY_H: "256", ESTELLA_VERIFY_STEPS: "2", ESTELLA_VERIFY_EXPECT: "[{\"x\":0.2353,\"y\":0.502,\"rgb\":[128,128,128],\"tol\":64},{\"x\":0.2392,\"y\":0.502,\"rgb\":[128,128,128],\"tol\":64},{\"x\":0.749,\"y\":0.502,\"rgb\":[128,128,128],\"tol\":64},{\"x\":0.7529,\"y\":0.502,\"rgb\":[128,128,128],\"tol\":64},{\"x\":0.502,\"y\":0.502,\"rgb\":[255,255,255],\"tol\":6},{\"x\":0.0784,\"y\":0.0784,\"rgb\":[0,0,0],\"tol\":6}]" } },
  { id: "ssao", tier: "pr", webgpu: true, env: { ESTELLA_VERIFY_SCENE: "/scenes/ssao.esscene", ESTELLA_VERIFY_W: "320", ESTELLA_VERIFY_H: "240", ESTELLA_VERIFY_STEPS: "4", ESTELLA_VERIFY_EXPECT: "[{\"x\":0.5016,\"y\":0.8996,\"rgb\":[191,191,191],\"tol\":6},{\"x\":0.3762,\"y\":0.4937,\"rgb\":[144,144,144],\"tol\":20},{\"x\":0.627,\"y\":0.4812,\"rgb\":[172,172,172],\"tol\":9},{\"x\":0.8527,\"y\":0.4686,\"rgb\":[147,147,147],\"tol\":9},{\"x\":0.1881,\"y\":0.5272,\"rgb\":[123,141,113],\"tol\":22},{\"x\":0.1285,\"y\":0.1967,\"rgb\":[133,136,148],\"tol\":9},{\"x\":0.627,\"y\":0.2008,\"rgb\":[179,184,199],\"tol\":5}]" } },
  ...
  // without, which is a lit floor rather than a dark one. The scene is asymmetric on
  // purpose — a symmetric one cannot see a mask sampled upside down.
  { id: "shadow2d-light-cap", tier: "pr", webgpu: true, env: { ESTELLA_VERIFY_PLAY: "1", ESTELLA_VERIFY_SCENE: "/scenes/shadow2d-light-cap.esscene", ESTELLA_VERIFY_MANIFEST: "/scenes/shadow2d-light-cap.textures.json", ESTELLA_VERIFY_W: "200", ESTELLA_VERIFY_H: "1000", ESTELLA_VERIFY_STEPS: "4", ESTELLA_VERIFY_EXPECT: "[{\"x\":0.70,\"y\":0.1,\"rgb\":[0,0,0],\"tol\":40},{\"x\":0.70,\"y\":0.3,\"rgb\":[0,0,0],\"tol\":40},{\"x\":0.70,\"y\":0.7,\"rgb\":[0,0,0],\"tol\":40},{\"x\":0.70,\"y\":0.9,\"rgb\":[0,0,0],\"tol\":40},{\"x\":0.70,\"y\":0.5,\"rgb\":[0,120,0],\"tol\":70}]" } },
  ...
  // The player's loss, judged by the picture: after the device comes back on its own, the frame
  // is the frame from before the loss, twice. One scene per kind of GPU object a recovery must
  // bring back, because each kind has had its own owner and its own way of being forgotten.
  { id: "device-roundtrip-grid", tier: "pr", webgpu: true, env: { ESTELLA_VERIFY_DEVICE_LOSS: "roundtrip", ESTELLA_VERIFY_LOSS_ROUNDS: "2", ESTELLA_VERIFY_SCENE: "/scenes/sprite-rendering.esscene", ESTELLA_VERIFY_MANIFEST: "/scenes/sprite-rendering.textures.json", ESTELLA_VERIFY_W: "256", ESTELLA_VERIFY_H: "256", ESTELLA_VERIFY_STEPS: "3", ESTELLA_VERIFY_LOSS_GRID: "64" } },
  { id: "device-roundtrip-instanced", tier: "pr", webgpu: true, env: { ESTELLA_VERIFY_DEVICE_LOSS: "roundtrip", ESTELLA_VERIFY_LOSS_ROUNDS: "2", ESTELLA_VERIFY_SCENE: "/scenes/mesh-instanced.esscene", ESTELLA_VERIFY_W: "256", ESTELLA_VERIFY_H: "256", ESTELLA_VERIFY_STEPS: "3" } },
  { id: "device-roundtrip-skin-material", tier: "pr", webgpu: true, env: { ESTELLA_VERIFY_DEVICE_LOSS: "roundtrip", ESTELLA_VERIFY_LOSS_ROUNDS: "2", ESTELLA_VERIFY_SCENE: "/scenes/mesh-skin-mat.esscene", ESTELLA_VERIFY_W: "256", ESTELLA_VERIFY_H: "256", ESTELLA_VERIFY_STEPS: "3" } },
  { id: "device-roundtrip-morph-material", tier: "pr", webgpu: true, env: { ESTELLA_VERIFY_DEVICE_LOSS: "roundtrip", ESTELLA_VERIFY_LOSS_ROUNDS: "2", ESTELLA_VERIFY_SCENE: "/scenes/mesh-morph-mat.esscene", ESTELLA_VERIFY_W: "256", ESTELLA_VERIFY_H: "256", ESTELLA_VERIFY_STEPS: "3" } },
  { id: "device-roundtrip-shadow-material", tier: "pr", webgpu: true, env: { ESTELLA_VERIFY_DEVICE_LOSS: "roundtrip", ESTELLA_VERIFY_LOSS_ROUNDS: "2", ESTELLA_VERIFY_SCENE: "/scenes/mesh-shadow-material.esscene", ESTELLA_VERIFY_W: "256", ESTELLA_VERIFY_H: "256", ESTELLA_VERIFY_STEPS: "3" } },
  { id: "device-roundtrip-sky", tier: "pr", webgpu: true, env: { ESTELLA_VERIFY_DEVICE_LOSS: "roundtrip", ESTELLA_VERIFY_LOSS_ROUNDS: "2", ESTELLA_VERIFY_SCENE: "/scenes/mesh-sky.esscene", ESTELLA_VERIFY_W: "256", ESTELLA_VERIFY_H: "256", ESTELLA_VERIFY_STEPS: "3" } },
  { id: "device-roundtrip-env", tier: "pr", webgpu: true, env: { ESTELLA_VERIFY_DEVICE_LOSS: "roundtrip", ESTELLA_VERIFY_LOSS_ROUNDS: "2", ESTELLA_VERIFY_SCENE: "/scenes/mat-env.esscene", ESTELLA_VERIFY_W: "256", ESTELLA_VERIFY_H: "256", ESTELLA_VERIFY_STEPS: "3" } },
  { id: "device-roundtrip-light-cookie", tier: "pr", webgpu: true, env: { ESTELLA_VERIFY_DEVICE_LOSS: "roundtrip", ESTELLA_VERIFY_LOSS_ROUNDS: "2", ESTELLA_VERIFY_SCENE: "/scenes/light-cookie.esscene", ESTELLA_VERIFY_MANIFEST: "/scenes/light-cookie.textures.json", ESTELLA_VERIFY_W: "256", ESTELLA_VERIFY_H: "256", ESTELLA_VERIFY_STEPS: "3" } },
  // A glyph page and a skeleton's atlas page come back from what made them, not from a copy:
